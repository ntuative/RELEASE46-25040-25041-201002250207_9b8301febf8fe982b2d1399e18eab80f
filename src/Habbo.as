package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_11:String = "client.init.volter.retry";
      
      public static const BAR_SPRITE:String = "barSprite";
      
      public static const const_13:String = "error_desc";
      
      public static const const_9:String = "client.init.volter.fail";
      ...
      public static const const_18:String = "client.init.swf.error";
      ...
      public static const const_3:String = "loadingBar";
      
      public static const const_2:String = "habboLogo";
      
      public static const const_15:String = "client.init.start";
      
      public static const const_12:String = "debug";
      
      private static const const_6:Number = 0.29;
      
      public static const const_8:String = "avg_update";
      
      public static const const_17:String = "client.init.volter.loaded";
      ...
      private static function positionLoadingScreenDisplayElements(param1:DisplayObjectContainer) : void
      {
         ...
         var _loc4_:Bitmap = param1.getChildByName(const_2) as Bitmap;
         if(_loc4_)
         {
            _loc4_.x = 117;
            _loc4_.y = 57;
         ...
         var _loc5_:Sprite = param1.getChildByName(const_3) as Sprite;
         if(_loc5_)
         {
            _loc5_.x = 89;
            _loc5_.y = 149;
      ...
      private static function positionLoadingScreenTextField(param1:DisplayObjectContainer) : void
      {
         ...
         if(_loc2_)
         {
            ...
            _loc3_ = param1.getChildByName(const_2) as Bitmap;
            if(_loc3_)
            {
      ...
      {
         var _loc7_:Sprite = param1.getChildByName(const_3) as Sprite;
