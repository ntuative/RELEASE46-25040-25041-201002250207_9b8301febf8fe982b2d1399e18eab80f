package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1042:uint = 1;
      ...
      private var var_2350:uint = 0;
      
      private var var_1143:ProfilerAgentTask;
      
      private var var_1144:ProfilerOutput;
      
      private var var_634:IWindowRenderer;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_634 = new WindowRenderer(_loc4_);
         var_212 = new Array(const_337);
         var _loc6_:int = 0;
         while(_loc6_ < const_337)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_634,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_212[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_227 = var_212[const_1042];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_227.getMouseCursor().defineCustomCursorType(MouseCursorType.const_332,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_227.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1229,_loc7_);
      }
      ...
      {
         return var_212[param1].getDesktopWindow().getChildAt(var_227.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1144 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1144 = new ProfilerOutput(_loc3_,this,var_634);
               var_1145 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1145);
               var_1143 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1143);
               var_958 = true;
            }
         }
      }
      ...
      {
         return var_227.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_1357.length > 0)
         {
            WindowContext.var_1357.flush();
         }
      ...
      {
         var _loc3_:Dictionary = var_377[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_377[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_227.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1357,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1190,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1287,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1238,param2.name + ": " + param2.toString());
            }
         }
      }
   }
