package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1393:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_309 && _loc4_.state != FriendRequest.const_315)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_309;
      ...
      {
         var_1390 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1391 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1391.procedure = onDismissAllButtonClick;
         var_1390.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_309 && _loc4_.state != FriendRequest.const_315)
            {
               _loc4_.state = FriendRequest.const_315;
               refreshRequestEntry(_loc4_);
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_268,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_81,param2);
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1390,_loc1_);
         setEnabled(var_1391,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_309;
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         var_47.removeListItem(param1.view);
         refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         var_47.addListItem(param1.view);
         _friendList.friendRequests.refreshShading();
         refreshButtons();
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_315;
         var _loc3_:DeclineBuddyMessageComposer = new DeclineBuddyMessageComposer();
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_268,param1));
         }
      }
   }
}
