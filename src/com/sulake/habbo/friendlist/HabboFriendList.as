package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1558:OpenedToWebPopup;
      
      private var var_866:IAvatarRenderManager;
      
      private var var_194:IHabboToolbar;
      
      private var var_424:FriendListTabs;
      
      private var _localization:IHabboLocalizationManager;
      
      private var _view:FriendListView;
      
      private var var_129:IHabboMessenger;
      
      private var var_1559:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_898:FriendRequests;
      
      private var var_1743:int;
      
      var var_13:FriendCategories;
      
      private var var_2188:FriendListLookAndFeel;
      ...
      {
         var_2188 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_13 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1559 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_898.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_898.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_424.findTab(FriendListTab.const_81).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_898 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_13.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_13.addCategory(new FriendCategory(FriendCategory.const_804,getText("friendlist.friends")));
         var_13.addCategory(new FriendCategory(FriendCategory.const_416,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_13.addFriend(new Friend(_loc4_));
         }
         var_424 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_514)
         {
            var_514 = new Timer(120000);
            var_514.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_514.start();
         }
         getBuddyRequests();
         registerListeners();
         var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_514.stop();
            var_514.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_514 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_129)
         {
            var_129.release(new IIDHabboMessenger());
            var_129 = null;
         }
         if(var_168)
         {
         ...
         if(var_866)
         {
            var_866.release(new IIDAvatarRenderManager());
            var_866 = null;
         }
         if(var_897)
         {
            var_897.release(new IIDHabboNotifications());
            var_897 = null;
         }
         if(var_194)
         {
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_129 = param2 as IHabboMessenger;
      ...
      {
         var _loc1_:String = var_168.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_424.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_314));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var_194 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1559.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_160,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_898.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_194.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:FriendListTab = var_424.findTab(FriendListTab.const_81);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_866.createAvatarImage(param1,AvatarScaleType.const_99);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_898.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_424.findTab(FriendListTab.const_81);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_866 = param2 as IAvatarRenderManager;
      ...
      {
         var_897 = param2 as IHabboNotifications;
      ...
      {
         return var_168.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1558 == null)
         {
            var_1558 = new OpenedToWebPopup(this);
         }
         var_1558.show(x,y);
      }
