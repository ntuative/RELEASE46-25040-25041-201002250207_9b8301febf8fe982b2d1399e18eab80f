package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_804:int = 0;
      
      public static const const_416:int = -1;
      
      public static const const_287:int = 100;
      ...
      {
         return Math.ceil(this.var_214.length / const_287);
      }
      ...
      {
         if(this.var_785 >= this.getPageCount())
         {
            this.var_785 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_214[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_214.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_785 + 1) * const_287,this.var_214.length);
      }
