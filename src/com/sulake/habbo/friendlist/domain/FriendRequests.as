package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_417:IFriendRequestsDeps;
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_871;
         var_417.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_417.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      {
         var_208.push(param1);
         var_417.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         {
            Util.remove(var_208,_loc4_);
            if(false)
            {
               var_417.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
