package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1119)
         {
            gotoRoom(var_1618,var_1616,var_1120);
            var_1119 = false;
            var_1120 = "";
         }
      }
      ...
      public function startSession(param1:IRoomSession) : Boolean
      {
         ...
         {
            var_750 = false;
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_85,param1));
      ...
      override public function dispose() : void
      {
         ...
         if(var_183)
         {
            while(false)
            {
               _loc1_ = var_183.getKey(0) as String;
               _loc2_ = var_183.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return var_183.getValue(_loc3_) as IRoomSession;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = var_183.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = getRoomIdentifier(param3,param4);
            _loc7_ = var_183.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            var_183.add(_loc5_,_loc6_);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = var_183.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_97,_loc4_));
            _loc4_.dispose();
         }
      }
