package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1083:UserDataManager;
      ...
      {
         if(var_33 == RoomSessionEvent.const_296 && _connection != null)
         {
            var_33 = RoomSessionEvent.const_85;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1083 as IUserDataManager;
      }
