package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1379:uint = 13232628;
      
      private static var var_1610:uint = 11129827;
      ...
      private var var_246:IBorderWindow;
      
      private var var_749:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_49.localization.registerParameter("help.tutorial.name.available","name",var_367);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_ok":
                  ...
                  break;
               case "button_cancel":
                  var_49.showView(TutorialUI.const_84);
                  break;
               case "button_usecurrent":
                  var_367 = var_49.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_49.localization.registerParameter("help.tutorial.name.confirmation","name",var_367);
         }
         if(var_246 == null)
         {
            var_246 = var_49.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_246 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_246);
            var_246.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_246.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_749 = new NameSuggestionListRenderer(var_49);
         var _loc6_:int = var_749.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1379;
