package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI
   {
      ...
      public static const const_313:String = "TUI_CLOTHES_VIEW";
      
      public static const const_394:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         var_49 = param1;
         var_49.events.addEventListener(HabboHelpTutorialEvent.const_667,onTaskDoneEvent);
         var_49.events.addEventListener(HabboHelpTutorialEvent.const_625,onTaskDoneEvent);
         var_49.events.addEventListener(HabboHelpTutorialEvent.const_539,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         var_49.hideUI();
         var_49.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_101));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1080 = true;
         if(var_28 != null && (var_28.id == const_248 || var_28.id == const_84))
         {
            showView(const_84);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1547;
         _window.width = _loc2_.width + var_1546;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_667:
               var_1078 = true;
               if(var_28 != null && var_28.id == const_394)
               {
                  showView(const_84);
               }
               break;
            case HabboHelpTutorialEvent.const_625:
               if(var_28 != null && var_28.id == const_313)
               {
                  var_1334 = true;
                  disposeWindow();
               }
      ...
      {
         var_1079 = true;
         if(var_28 != null && (var_28.id == const_313 || var_28.id == const_84))
         {
            showView(const_84);
         }
      }
      ...
      {
         return var_1079 && var_1080 && var_1078;
      }
   }
}
