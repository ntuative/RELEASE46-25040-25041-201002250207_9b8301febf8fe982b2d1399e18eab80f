package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1101:int = 0;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_710 == null || _loc3_ < 0 || _loc3_ >= var_710.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_710[_loc3_];
            main.showUI(HabboHelpViewEnum.const_544);
            main.tellUI(HabboHelpViewEnum.const_544,null);
         }
      }
   }
}
