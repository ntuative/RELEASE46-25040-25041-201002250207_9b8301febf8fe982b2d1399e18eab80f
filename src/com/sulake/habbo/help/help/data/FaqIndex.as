package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_711:FaqCategory;
      
      private var var_712:FaqCategory;
      ...
      {
         super();
         var_712 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_711 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_135 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_712.hasItem(param1))
         {
            var_712.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_711.hasItem(param1))
         {
            var_711.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
