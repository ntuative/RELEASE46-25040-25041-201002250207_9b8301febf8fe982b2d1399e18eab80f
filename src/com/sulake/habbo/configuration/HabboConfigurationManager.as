package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private var var_935:Dictionary;
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1347);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_935[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_879 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_161));
         if(var_1611)
         {
      ...
      {
         var _loc4_:String = var_935[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_1612);
      ...
      private function init() : void
      {
         ...
         if(!var_879)
         {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.const_43,onConfigurationError);
         }
      }
