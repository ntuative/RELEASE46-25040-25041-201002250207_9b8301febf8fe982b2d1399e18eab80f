package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_23:IHabboCommunicationManager;
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_8 = param1;
         var_23 = var_8.communication;
         var_23.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_23.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_23.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_23.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_23.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_23.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_23.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_23.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_23.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_23.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_23.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_23.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_23.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_23.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_23.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_23.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_23.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_23.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_23.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_23.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_23.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_23.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_23.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_23.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_23.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_23.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_23.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_23.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_23.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_23.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_23.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_23.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_23.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_23.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_23.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_23.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
         var_23.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
         var_23.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(onNotEnoughCredits));
      }
      ...
      private function onPetRemoved(param1:PetRemovedFromInventoryEvent) : void
      {
         ...
         var _loc3_:PetsModel = var_8.petsModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onFurniListRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FurniModel = var_8.furniModel;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_69,false);
      }
      ...
      {
         var _loc2_:EffectsModel = var_8.effectsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_8.notifyChangedEffects();
      }
      
      private function onTradingAccepted(param1:IMessageEvent) : void
      {
         var _loc2_:TradingModel = var_8.tradingModel;
         if(_loc2_ != null)
         {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_507);
         _loc2_.refreshViews();
         var_8.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = var_8.furniModel;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         var _loc12_:TradingModel = var_8.tradingModel;
         if(_loc12_ != null)
         {
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            var_8.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember);
            var_8.events.dispatchEvent(new HabboInventoryHabboClubEvent());
         }
      }
      ...
      private function onMarketplaceItemStats(param1:MarketplaceItemStatsEvent) : void
      {
         ...
         var _loc3_:MarketplaceModel = var_8.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
         _loc3_.setAveragePrice(_loc2_.furniCategoryId,_loc2_.furniTypeId,_loc2_.method_1);
      }
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:BadgesModel = var_8.badgesModel;
         if(_loc3_ != null)
         {
            _loc3_.updateBadge(_loc2_.badgeID,false);
            _loc3_.removeBadge(_loc2_.removedBadgeID);
         }
         var _loc4_:AchievementsModel = var_8.achievementsModel;
         if(_loc4_ != null)
         {
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_23.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_172);
      }
      ...
      public function onUserBadges(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.userId != var_8.sessionData.userId)
         {
            return;
         }
         var _loc3_:BadgesModel = var_8.badgesModel;
      ...
      {
         var_8.creditBalance = (param1 as CreditBalanceEvent).getParser().balance;
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_8.setInventoryCategoryInit(InventoryCategory.const_323);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_69);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:ISessionDataManager = var_8.sessionData;
         var _loc3_:IRoomSession = var_8.roomSession;
         if(_loc3_ == null)
         {
            return;
         }
         var_8.toggleInventorySubPage(InventorySubCategory.const_237);
         ...
         var _loc11_:TradingModel = var_8.tradingModel;
         if(_loc11_ != null)
         {
      ...
      {
         var _loc2_:PetsModel = var_8.petsModel;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_8.setInventoryCategoryInit(InventoryCategory.const_231);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_402);
         var _loc4_:FurniModel = var_8.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
      ...
      {
         var_8.pixelBalance = (param1 as HabboActivityPointNotificationMessageEvent).amount;
      }
      ...
      private function onNotEnoughCredits(param1:NotEnoughBalanceMessageEvent) : void
      {
         ...
         var _loc2_:MarketplaceModel = var_8.marketplaceModel;
         if(_loc2_ == null)
         {
            return;
         }
