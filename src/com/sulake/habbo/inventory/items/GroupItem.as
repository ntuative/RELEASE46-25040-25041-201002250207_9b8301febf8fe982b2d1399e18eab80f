package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1606:int = 13421772;
      ...
      protected var var_2259:BitmapData;
      
      protected var var_925:Boolean;
      
      protected var var_2254:Boolean;
      
      protected var var_1651:int;
      ...
      private const const_1607:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_361:BitmapData;
      
      private const const_1406:Number = 0.2;
      
      protected var var_1364:Boolean;
      
      private const const_1407:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_521)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(_mainCategory == FurniModel.const_40)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1500));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1359);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1406;
               _loc1_.blend = const_1406;
            }
            else
            {
               _window.blend = const_1407;
               _loc1_.blend = const_1407;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1364 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2259;
               _loc5_.visible = true;
            }
            else
            {
