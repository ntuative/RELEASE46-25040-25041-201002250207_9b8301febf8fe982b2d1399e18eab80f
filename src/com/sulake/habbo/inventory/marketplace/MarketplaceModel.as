package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function method_9() : void
      {
         ...
         var _loc2_:int = var_234 is FloorItem ? 1 : 2;
         var_1734 = _loc2_;
         var_1731 = var_234.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_234.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1537,var_1536);
         }
      }
      ...
      {
         if(param1 != var_1734 || param2 != var_1731)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1735);
      }
      ...
      {
         if(var_10 != null && false && var_234 != null)
         {
            var_10.furniModel.removeLockFrom(var_234.id);
            var_234 = null;
         }
      }
