package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_885.length)
         {
            if(var_885[_loc2_] == param1)
            {
               var_885.splice(_loc2_,1);
      ...
      {
         if(param1 == InventoryCategory.const_231 && false)
         {
            var_10.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_328.getBadgeImage(param1);
            var_272.push(_loc8_);
            if(param2)
            {
