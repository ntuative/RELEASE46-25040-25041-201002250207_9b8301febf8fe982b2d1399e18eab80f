package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_826:IRoomSession;
      ...
      private const const_1610:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_17 != null)
         {
            var_17.events.removeEventListener(RoomSessionEvent.const_85,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionEvent.const_97,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_378,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               var_826 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_378:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_45.getValue(InventoryCategory.const_507));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_45.getValue(InventoryCategory.const_69));
      }
      ...
      {
         var_158.clubPeriods = param1;
         var_158.clubDays = param2;
         var_158.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_45.getValue(InventoryCategory.const_172));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_903));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1610);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_45.getValue(InventoryCategory.const_323));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_237:
               _view.toggleCategoryView(InventoryCategory.const_69,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_825.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_825.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_45.getValue(InventorySubCategory.const_237));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_328 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_825.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_158.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_45.getValue(InventoryCategory.const_402) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1019 = new IncomingMessages(this);
      ...
      {
         return var_158.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_158.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_45.getValue(InventoryCategory.const_231));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_85,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionEvent.const_97,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_378,roomSessionEventHandler);
         ...
         var_45.add(InventoryCategory.const_402,_loc3_);
         ...
         var_45.add(InventoryCategory.const_69,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_328);
         var_45.add(InventoryCategory.const_231,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_45.add(InventoryCategory.const_507,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_328);
         var_45.add(InventoryCategory.const_323,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_45.add(InventorySubCategory.const_237,_loc8_);
         ...
         var_45.add(InventoryCategory.const_172,_loc10_);
