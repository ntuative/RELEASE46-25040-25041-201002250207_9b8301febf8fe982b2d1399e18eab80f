package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_388:uint = 4;
      ...
      public static const const_1174:uint = 9;
      
      public static const const_209:uint = 5;
      ...
      private var var_486:Boolean = false;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_486 = false;
         var_700 = false;
         var_46.updateItemList(var_699);
         var_46.updateItemList(var_1274);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_46.alertPopup(TradingView.const_859);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_486 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_46.alertPopup(TradingView.const_852);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_33 + " NEW STATE: " + param1 + " OWN: " + var_486 + " OTHER: " + var_700);
         ...
         {
            case const_163:
               if(param1 == const_166 || param1 == const_209)
               {
                  var_33 = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         {
            _loc2_ = var_229.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(var_229.getValue(_loc6_) == null)
            {
               return false;
            }
            _communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
      ...
      public function close() : void
      {
         if(var_604)
         {
            if(var_33 != const_163 && var_33 != const_209)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_163;
            var_8.toggleInventorySubPage(InventorySubCategory.const_950);
            var_604 = false;
         }
         var_46.setMinimized(false);
      }
