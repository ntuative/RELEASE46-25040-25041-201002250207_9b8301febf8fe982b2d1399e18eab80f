package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_781:uint = 4284532064;
      
      private static const const_780:uint = 2577770;
      ...
      private var var_354:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_354 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_798)
            {
            ...
            var_354.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_447);
            var_354.show();
         }
      ...
      {
         var _loc2_:ITextWindow = var_63.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_63.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_177)
            {
               var_177.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_177.stop();
               var_177 = null;
            }
            if(var_354 != null)
      ...
      {
         return var_63.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      ...
      {
         var _loc2_:ITextWindow = var_63.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_63.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(var_63 == null)
         {
            var_63 = createNormalWindow();
         }
         if(var_1564 == null)
         {
            var_1564 = createMinimizedWindow();
         }
         if(!var_2193)
         {
            return var_63;
      ...
      {
         var _loc2_:ITextWindow = var_63.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      protected function method_14(param1:uint) : void
      {
         var _loc2_:* = null;
      ...
      {
         var _loc1_:ITextWindow = var_63.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_63.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function startConfirmCountdown() : void
      {
         if(var_177 == null)
         {
            var_177 = new Timer(1000,3);
            var_177.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_177.reset();
         var_177.repeatCount = 3;
         var_177.start();
      ...
      {
         var _loc1_:ITextWindow = var_63.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_63.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            updateActionState();
            _loc2_ = var_63.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = var_22.otherUserName;
            }
            _loc1_ = var_63.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_781) : uint(const_780);
            }
            _loc3_ = var_63.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = var_63.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_781) : uint(const_780);
            }
            _loc3_ = var_63.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      {
         return var_63.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_63)
         {
            _loc1_ = var_63.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
            switch(var_22.state)
            {
               ...
               case TradingModel.const_227:
                  ...
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_388:
                  _loc1_.disable();
                  showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_209:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
