package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1041:int = 100;
      
      public static const const_292:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_218,onObjectPlaced);
         var_444 = new Timer(const_1041,1);
         var_444.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_10.getSubCategoryViewId() == InventorySubCategory.const_237;
      }
      ...
      {
         return var_10.canUserOfferToTrade();
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_373.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_373.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_521)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_218,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_444 != null)
            {
               var_444.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_444.stop();
               var_444 = null;
            }
            if(var_120 != null)
            {
               var_120.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_120.stop();
               var_120 = null;
            }
            if(var_627 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         {
            var_951 = param1.ref;
            if(!var_10.recyclerModel.running)
            {
               requestClose();
            }
            var_753 = true;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_320)
         {
         ...
         else if(param3 == FurniCategory.const_302)
         {
         ...
         if(var_627 == null)
         {
            var_627 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_627.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,_roomEngine,_loc9_.clone(),var_10.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = var_10.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_237:
               ...
               break;
            case InventorySubCategory.const_950:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_120 = new Timer(param1,1);
            var_120.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_120.start();
         }
         else
         {
      ...
      {
         var_10.checkCategoryInitilization(InventoryCategory.const_402);
      ...
      {
         if(param1 == InventoryCategory.const_69 && false)
         {
            switch(_view.visibleCategoryId)
            {
               case const_40:
                  var_10.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_41:
                  var_10.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_292:
                  var_10.toggleInventoryPage(InventoryCategory.const_172);
            }
         }
      }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc3_:RecyclerModel = var_10.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      {
         if(var_753 && param1.type == RoomEngineObjectEvent.const_218)
         {
            var_10.showView();
            var_753 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_302 || _loc3_.category == FurniCategory.const_320 || _loc3_.category == FurniCategory.const_316)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_373 = new Map();
         var_373.add(const_40,new Array());
         var_373.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
