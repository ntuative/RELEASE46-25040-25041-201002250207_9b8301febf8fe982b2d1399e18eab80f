package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsModel implements IInventoryModel
   {
      ...
      private var var_831:EffectListProxy;
      ...
      public function EffectsModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager)
      {
         ...
         var_831 = new EffectListProxy(this,1);
         _inactiveEffectsProxy = new EffectListProxy(this,0);
         _view = new EffectsView(this,param2,param4,param5,var_831,_inactiveEffectsProxy);
      }
      ...
      public function getEffects(param1:int = -1) : Array
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < var_258.length)
         {
            _loc4_ = var_258[_loc3_];
      ...
      public function stopUsingAllEffects(param1:Boolean = true, param2:Boolean = true) : void
      {
         ...
         if(param1)
         {
            var_10.communication.getHabboMainConnection(null).send(new AvatarEffectSelectedComposer(-1));
         }
         if(param2)
         {
            refreshViews();
      ...
      {
         var_10.communication.getHabboMainConnection(null).send(new AvatarEffectActivatedComposer(param1));
      }
      ...
      public function useEffect(param1:int) : void
      {
         ...
         {
            _loc2_.isInUse = true;
            var_10.communication.getHabboMainConnection(null).send(new AvatarEffectSelectedComposer(param1));
            refreshViews();
         }
      }
