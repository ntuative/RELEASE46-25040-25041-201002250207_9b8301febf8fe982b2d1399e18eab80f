package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1629:String = "room_widget";
      
      private const const_1118:String = "room_view";
      
      private var var_53:IWindowContainer;
      
      private var var_723:int = 50;
      
      private var var_2321:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_53.getChildByTag(const_1118) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_53.findChildByTag(const_1118) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_723;
               _loc2_.width = var_53.desktop.width - var_723;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_723;
               _loc2_.height = var_53.desktop.height - var_723;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_53.desktop.width;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1629) == 0)
            {
