package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1140:IHabboAvatarEditor = null;
      
      private var _adManager:IAdManager;
      
      private var var_765:IRoomWidgetFactory;
      ...
      private var var_328:ISessionDataManager;
      ...
      private var var_764:IHabboHelp;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_954 = RoomDesktop.const_397;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = var_765;
         _loc3_.sessionDataManager = var_328;
         _loc3_.roomSessionManager = var_17;
         _loc3_.friendList = _friendList;
         _loc3_.avatarRenderManager = var_550;
         _loc3_.inventory = var_8;
         _loc3_.toolbar = var_194;
         _loc3_.navigator = _navigator;
         _loc3_.avatarEditor = var_1140;
         _loc3_.catalog = _catalog;
         _loc3_.adManager = _adManager;
         _loc3_.localization = _localization;
         _loc3_.habboHelp = var_764;
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               if(param1.session != null)
               {
                  ...
                  var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.ZOOM));
                  var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.MEMENU));
                  var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            _adManager.events.addEventListener(AdEvent.const_375,adEventHandler);
            _adManager.events.addEventListener(AdEvent.const_473,adEventHandler);
            _adManager.events.addEventListener(AdEvent.const_429,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_765 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_765 != null)
         {
            var_765.release(new IIDHabboRoomWidget());
            var_765 = null;
         }
         if(var_8 != null)
         {
         ...
         if(var_550 != null)
         {
            var_550.release(new IIDAvatarRenderManager());
            var_550 = null;
         }
         if(_catalog != null)
         {
         ...
         if(var_764 != null)
         {
            var_764.release(new IIDHabboHelp());
            var_764 = null;
         }
         ...
         if(var_328 != null)
         {
            var_328.release(new IIDSessionDataManager());
            var_328 = null;
         }
         var_1140 = null;
         _connection = null;
         if(var_249)
         {
            while(false)
            {
               _loc1_ = var_249.getKey(0) as String;
               _loc2_ = var_249.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = var_249.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_328 = param2 as ISessionDataManager;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = var_249.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_639:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_720);
               ...
               if(var_954 != RoomDesktop.const_397)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_272,var_954);
               }
               if(_adManager != null)
               {
               ...
               break;
            case RoomEngineEvent.const_588:
               disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_628:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_188:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_664:
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomEngineEvent.const_639,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_588,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.DIMMER_STATE,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_628,roomEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_732,roomObjectEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_550 = param2 as IAvatarRenderManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_17)
         {
            var_17.events.addEventListener(RoomSessionEvent.const_296,roomSessionStateEventHandler);
            ...
            var_17.events.addEventListener(RoomSessionChatEvent.const_137,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionUserBadgesEvent.const_105,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionDoorbellEvent.const_95,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionDoorbellEvent.const_124,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionDoorbellEvent.const_53,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionPresentEvent.const_254,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_205,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_219,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_562,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_937,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_921,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_196,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_202,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_223,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_189,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_225,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_188,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_212,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_664,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_707,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_157,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_616,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_558,roomSessionDialogEventHandler);
            var_17.events.addEventListener(RoomSessionQueueEvent.const_361,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionVoteEvent.const_106,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionVoteEvent.const_128,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionPollEvent.const_108,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionPollEvent.const_60,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionPollEvent.const_102,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionDimmerPresetsEvent.const_480,roomSessionEventHandler);
            var_17.events.addEventListener(RoomSessionFriendRequestEvent.const_109,roomSessionEventHandler);
         }
      }
      ...
      {
         return var_249.getValue(param1) as RoomDesktop;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1140 = param2 as IHabboAvatarEditor;
      }
   }
}
