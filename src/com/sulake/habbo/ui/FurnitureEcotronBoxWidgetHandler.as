package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_548,RoomWidgetEcotronBoxOpenMessage.const_573,RoomWidgetEcotronBoxOpenedMessage.const_1353];
      }
      ...
      {
         return RoomWidgetEnum.const_385;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_548:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_573:
