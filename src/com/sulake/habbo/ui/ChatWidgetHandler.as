package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_505:Point = null;
      
      private var var_724:Map = null;
      
      private var var_504:Vector3d;
      
      private var _connection:IConnection = null;
      
      private var var_503:Map = null;
      
      public function ChatWidgetHandler()
      {
         var_504 = new Vector3d();
         super();
         var_503 = new Map();
         var_724 = new Map();
      }
      ...
      {
         return [RoomSessionChatEvent.const_137];
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_503.length)
            {
               _loc2_ = var_503.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_137:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_503.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_724.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_299:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_99);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_99);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_503.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_724.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_599,RoomWidgetChatSelectAvatarMessage.const_560];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_599:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_137,_container.roomSession,0,"Version 25040-25041-201002250139");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_893 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_893);
            }
            if(var_505 == null)
            {
               var_504.x = 0;
               var_504.y = 0;
               var_504.z = 0;
               var_505 = _loc4_.getScreenPoint(var_504);
               var_893 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_504.x = 0;
            var_504.y = 0;
            var_504.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_504);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_505.x || _loc8_.y != var_505.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_505,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_333;
      }
