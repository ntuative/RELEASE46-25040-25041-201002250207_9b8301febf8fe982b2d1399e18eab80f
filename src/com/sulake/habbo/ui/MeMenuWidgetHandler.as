   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_194 + " " + _loc6_);
            if(var_194 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_870,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_194.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_611,onFigureUpdate);
            }
            if(false)
            {
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_611,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_903,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_885,onHabboClubSubscriptionChanged);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_470:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_396));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_577);
         _loc1_.push(RoomWidgetDanceMessage.const_508);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_538);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_524);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_694);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_550);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_631);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_697);
         _loc1_.push(RoomWidgetStopEffectMessage.const_498);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1168);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_802);
         _loc1_.push(RoomWidgetToolbarMessage.const_516);
         _loc1_.push(RoomWidgetToolbarMessage.const_583);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_574);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1182);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_977);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_541);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_730);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_727);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_566);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1292);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_527);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_586);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_624);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_675));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_730:
               ...
               break;
            case RoomWidgetWaveMessage.const_577:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_508:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_538:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_524:
               if(var_8 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_694:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_697:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_636)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_257,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_631:
               ...
               if(var_8 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_858:
                        _catalog.openCatalogPage(CatalogPageName.const_1187,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_883:
                        var_8.toggleInventoryPage(InventoryCategory.const_231);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_498:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_873:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_802:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_541:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_516:
               ...
               if(var_194)
               {
                  var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_8 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_583:
               ...
               if(var_194 && false)
               {
                  var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_427,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_574:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == 0)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_433,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_982));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_433,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1233));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_625));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_727:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_566:
            ...
            case RoomWidgetStoreSettingsMessage.const_527:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_305,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_586:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_305,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_624:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_539));
               }
               break;
            default:
