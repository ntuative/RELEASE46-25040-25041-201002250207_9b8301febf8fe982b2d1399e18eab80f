package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_95:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_605,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_124:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_124,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_603];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_603:
      ...
      {
         return [RoomSessionDoorbellEvent.const_95,RoomSessionDoorbellEvent.const_124,RoomSessionDoorbellEvent.const_53];
      }
