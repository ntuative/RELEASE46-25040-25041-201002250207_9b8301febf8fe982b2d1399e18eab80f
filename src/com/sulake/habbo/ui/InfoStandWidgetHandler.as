package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_114,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_149,onFigureUpdate);
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_114,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_149,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_661);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_317);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_954);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1000);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_299)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_466)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_895)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_623);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_211)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_215)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_557);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1283;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_888;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1005;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1227);
               }
               else
               {
               ...
               _loc18_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_50);
               if(_loc18_ != null)
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_533.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_533.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_557);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_105];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_326);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_579);
         _loc1_.push(RoomWidgetUserActionMessage.const_665);
         _loc1_.push(RoomWidgetUserActionMessage.const_403);
         _loc1_.push(RoomWidgetUserActionMessage.const_531);
         _loc1_.push(RoomWidgetUserActionMessage.const_656);
         _loc1_.push(RoomWidgetUserActionMessage.const_564);
         _loc1_.push(RoomWidgetUserActionMessage.const_689);
         _loc1_.push(RoomWidgetUserActionMessage.const_513);
         _loc1_.push(RoomWidgetFurniActionMessage.const_244);
         _loc1_.push(RoomWidgetFurniActionMessage.const_718);
         _loc1_.push(RoomWidgetFurniActionMessage.const_731);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_615);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_632);
         _loc1_.push(RoomWidgetUserActionMessage.const_468);
         _loc1_.push(RoomWidgetUserActionMessage.const_702);
         _loc1_.push(RoomWidgetUserActionMessage.const_729);
         _loc1_.push(RoomWidgetUserActionMessage.const_1132);
         _loc1_.push(RoomWidgetPetCommandMessage.const_553);
         _loc1_.push(RoomWidgetPetCommandMessage.const_654);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_105:
      ...
      public function dispose() : void
      {
         ...
         if(var_533 != null)
         {
            _loc1_ = var_533.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_533.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_326:
            ...
            case RoomWidgetUserActionMessage.const_676:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_980,_loc3_.name);
               _container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_579:
            ...
            case RoomWidgetUserActionMessage.const_665:
               ...
               break;
            case RoomWidgetUserActionMessage.const_403:
               _container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_531:
               _container.roomSession.banUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_656:
            ...
            case RoomWidgetUserActionMessage.const_564:
               ...
               break;
            case RoomWidgetUserActionMessage.const_689:
            ...
            case RoomWidgetRoomTagSearchMessage.const_615:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_632:
            ...
            case RoomWidgetUserActionMessage.const_468:
               ...
               break;
            case RoomWidgetUserActionMessage.const_702:
