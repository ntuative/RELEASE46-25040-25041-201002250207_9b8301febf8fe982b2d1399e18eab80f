package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_462:IBitmapWrapperWindow;
      
      private var _window:IWindowContainer;
      
      private var var_1151:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1151 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_462 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_462.bitmap = new BitmapData(var_462.width,var_462.height,true,16777215);
         var_462.bitmap.copyPixels(var_1151,var_1151.rect,new Point(0,0 - 0 - 8));
         var_462.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
