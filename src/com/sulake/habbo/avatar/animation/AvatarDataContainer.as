package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2181:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1562,var_1561,var_1563,_alphaMultiplier);
         var_1074 = generatePaletteMapForGrayscale(var_2182,var_2183);
      }
      
      public function get reds() : Array
      {
         return var_1074.getValue("reds") as Array;
      }
      ...
      {
         return var_1074.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1074.getValue("greens") as Array;
      }
      ...
      {
         return var_1074.getValue("alphas") as Array;
      }
