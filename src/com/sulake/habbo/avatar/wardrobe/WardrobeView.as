package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_629:IItemListWindow;
      
      private var var_531:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_755:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_629 = _window.findChildByName("mylooks") as IItemListWindow;
         var_531 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_755 = _window.findChildByName("selector") as IItemListWindow;
         var_1398 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _model.selectMyLook(var_629.getListItemIndex(param2.parent));
         }
      }
      ...
      private function initSelector() : void
      {
         ...
         {
            var_755.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_532 = [];
         while(true)
         {
            ...
            var_755.addListItem(_loc1_.window);
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in _model.hotLooks)
         {
            ...
            {
               var_531.addListItem(_loc3_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_755.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_756 * 8 + var_531.getListItemIndex(param2.parent);
