package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_36["null"] = new AvatarEditorGridView(param1,FigureData.const_111,param2,param3);
         var_36["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         var_36["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         var_36["null"] = new AvatarEditorGridView(param1,FigureData.const_148,param2,param3);
         var_36["null"] = new AvatarEditorGridView(param1,FigureData.const_144,param2,param3);
         _window.visible = false;
         _window.procedure = windowEventProc;
         attachImages();
         switchCategory(FigureData.const_111);
      }
