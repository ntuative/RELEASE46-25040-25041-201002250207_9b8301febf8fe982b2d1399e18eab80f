package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_875:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_2060:IStructureData;
      
      private var var_1518:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1518 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_2060.append(var_1518);
         dispatchEvent(new Event(AvatarStructureDownload.const_875));
      }
   }
}
