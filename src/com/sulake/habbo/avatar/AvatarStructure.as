package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_376:PartSetsData;
      
      private var var_1659:PartOffsetData;
      
      private var var_769:AvatarActionManager;
      
      private var var_146:IAssetLibrary;
      
      private var var_2277:IAssetLibrary;
      
      private var var_1372:Boolean = false;
      
      private var var_1658:AvatarRenderManager;
      
      private var var_449:FigureData;
      ...
      private var var_1400:AvatarStructureDownloadSet;
      
      private var var_632:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_146 = param2;
         var_2277 = param3;
         var_449 = new FigureData();
         var_376 = new PartSetsData();
         _animationData = new AnimationData();
         var_1400 = new AvatarStructureDownloadSet();
         var_632 = new AnimationManager();
         var_631 = param4;
         var_1659 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_769.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_631)
         {
            case AvatarType.const_86:
               _loc1_ = var_146.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_376.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_146.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_146.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_449.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_146.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_376.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_146.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_146.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_449.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_769.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_769.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_632.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_376.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_376.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1281[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_769.getDefaultActionType();
         var _loc7_:Array = var_376.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_632.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_449.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_449.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_376.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_376.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_86:
               if(var_146.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_146.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_146.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_146.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_631 + " ready to go!");
         if(var_631 == AvatarType.const_86)
         {
            var_376.getPartDefinition("ri").appendToFigure = true;
            var_376.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_86:
               var_1400.add(new AvatarStructureDownload(var_146,_loc5_,var_449));
               break;
            case AvatarType.PET:
         }
         var_1400.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_632.getAnimation(param1);
      }
      ...
      {
         var_769 = new AvatarActionManager(var_146,var_631);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_146.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_146.getAssetByName("dance" + _loc1_).content as XML;
            var_632.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_146.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_146.getAssetByName("fx" + _loc1_).content as XML;
            var_632.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_449.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_449.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_769.sortActions(param1);
      }
   }
}
