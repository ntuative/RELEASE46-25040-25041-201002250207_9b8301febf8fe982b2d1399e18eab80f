package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1475:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1475 = new Dictionary();
         super();
         _id = String(param1.@id);
         var_33 = String(param1.@state);
         var_1893 = parseInt(param1.@precedence);
         var_1891 = String(param1.@activepartset);
         var_1887 = String(param1.@assetpartdefinition);
         var_1892 = String(param1.@lay);
         var_1197 = String(param1.@geometrytype);
         var_1626 = Boolean(parseInt(param1.@main));
         var_1888 = Boolean(parseInt(param1.@FlatCreatedEvent));
         var_1889 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "FlatCreatedEvent")
            {
               var_1890 = _loc6_;
            }
            else
            {
               var_1475[_loc5_] = _loc6_;
            }
         }
      ...
      {
         return var_1224.concat(getTypePrevents(param1));
      }
