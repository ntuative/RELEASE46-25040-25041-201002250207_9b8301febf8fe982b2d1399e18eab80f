package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private const const_1605:int = 3;
      
      private var _category:String;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_388:IItemGridWindow;
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_388 = _view.findChildByName("thumbs") as IItemGridWindow;
            var_658 = _view.findChildByName("colors") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_388.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = var_658.getGridItemIndex(param1.window);
      ...
      public function initFromList() : void
      {
         ...
         {
            var_388.addGridItem(_loc2_.view);
         ...
         {
            var_658.addGridItem(_loc3_.view);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_48)
         {
            _loc3_ = var_388.getGridItemIndex(param1.window);
