package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectColorIndex(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(var_64.length <= _selectedColorLayerIndex)
         {
            return null;
         }
         if(!_palette)
         ...
         var_64[_selectedColorLayerIndex] = param1;
      ...
      {
         return _data[var_736] as AvatarEditorGridPartItem;
      }
      ...
      public function selectItemIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_736 >= 0 && _data.length > var_736)
         {
            _loc3_ = _data[var_736];
      ...
      public function selectColorLayerIndex(param1:int) : void
      {
         ...
         while(var_64.length <= param1)
         {
            var_64.push(-1);
         }
         selectColorIndex(var_64[_selectedColorLayerIndex]);
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_64 = new Array(param1.length);
         var _loc3_:int = 0;
