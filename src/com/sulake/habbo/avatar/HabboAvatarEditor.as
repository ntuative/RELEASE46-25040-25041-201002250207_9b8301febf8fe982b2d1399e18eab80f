package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_573:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_695.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1269)
         {
            ...
            var_484["null"] = new FigureData(this);
            var_484["null"] = new FigureData(this);
            _loc1_ = var_484["null"];
            _loc2_ = var_484["null"];
            ...
            var_13 = new Map();
            var_13.add(AvatarEditorCategory.const_865,new GenericModel(this));
            var_13.add(AvatarEditorCategory.const_46,new HeadModel(this));
            var_13.add(AvatarEditorCategory.const_325,new TorsoModel(this));
            var_13.add(AvatarEditorCategory.const_1317,new LegsModel(this));
            var_13.add(AvatarEditorCategory.const_939,new WardrobeModel(this));
            var_1269 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_573 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1047 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1047 >= _loc14_.clubLevel))
               {
                  _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1582.clone() as IWindowContainer,param1,_loc14_);
                  _loc4_.push(_loc17_);
            ...
            if(_loc8_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1358.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1306)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_1047 >= _loc5_.clubLevel))
               {
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1358.clone() as IWindowContainer,param1,_loc5_,_loc12_,_loc15_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_13.getValue(AvatarEditorCategory.const_939);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_695.getPalette(param1);
      }
      ...
      {
         var_695 = var_550.getFigureData(AvatarType.const_86);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_550 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_227 == null)
            {
               var_227 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_56,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_227.addChild(_view.window);
               var_227.center();
               var_227.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_865);
         if(var_573 != null)
         {
            var_573.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1047 = param3;
         var _loc4_:FigureData = var_484[param2];
         if(_loc4_ == null)
         {
            return;
         }
