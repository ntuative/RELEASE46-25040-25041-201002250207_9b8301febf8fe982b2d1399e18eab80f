package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = _y * param1.z - var_84 * param1.y;
         _loc2_.y = var_84 * param1.x - var_85 * param1.z;
         _loc2_.z = var_85 * param1.y - _y * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(var_85 * var_85 + _y * _y + var_84 * var_84);
      }
      ...
      {
         return var_85 * param1.x + _y * param1.y + var_84 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_85 + "," + _y + "," + var_84 + "," + var_1041 + ")";
      }
