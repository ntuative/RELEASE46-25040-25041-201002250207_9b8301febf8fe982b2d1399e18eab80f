package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1325:int = 1;
       
      
      private var _closedConversations:Array;
      
      private var var_417:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(false)
         {
            var_137[0].setSelected(true);
         }
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_678,0,var_417.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_417.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_417.getTabCount());
      ...
      {
         return var_417.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function closeConversation() : void
      {
         ...
         var _loc2_:int = var_137.indexOf(_loc1_);
         Util.remove(var_137,_loc1_);
         ...
         while(_loc2_ >= 0)
         {
            if(false)
            {
               var_137[_loc2_].setSelected(true);
               break;
            }
            _loc2_--;
         }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         var _loc2_:int = var_137.indexOf(param1);
         while(_startIndex + var_417.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_417.addMsgToView(_loc3_,_loc4_);
      }
      ...
      public function setFollowingAllowedAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         if(_loc3_.selected)
         {
            var_417.refresh(false);
         }
      }
      
      public function addTestUser() : void
      {
         this.addConversation(var_1325++);
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_417.addMsgToView(_loc3_,param1);
         if(_loc2_ != var_137.length || _loc4_ != _loc3_.newMessageArrived)
         {
            var_417.refresh(false);
         }
      }
