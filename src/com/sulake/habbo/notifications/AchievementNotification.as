package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_2035 = param2;
         var_328 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_114,onBadgeImageReady);
         ...
         var_182 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_2178 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_182);
      ...
      public function dispose() : void
      {
         if(var_328 != null)
         {
            var_328.events.removeEventListener(BadgeImageReadyEvent.const_114,onBadgeImageReady);
            var_328 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_727,var_2178);
               }
               dispose();
               break;
      ...
      private function registerBadgeParameters(param1:String) : void
      {
         ...
         _localizations.registerParameter(param1,"level",var_2035.toString());
         _localizations.registerParameter(param1,"name",var_328.userName);
         _localizations.registerParameter(param1,"realname",var_328.realName);
      }
   }
}
