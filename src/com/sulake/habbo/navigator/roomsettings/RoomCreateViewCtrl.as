package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1167:Boolean = true;
      
      private var var_788:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_459 = new Timer(100);
         var_459.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_61 = new Array();
         var_61.push(new RoomLayout(false,104,"a"));
         var_61.push(new RoomLayout(false,94,"b"));
         var_61.push(new RoomLayout(false,36,"c"));
         var_61.push(new RoomLayout(false,84,"d"));
         var_61.push(new RoomLayout(false,80,"e"));
         var_61.push(new RoomLayout(false,80,"f"));
         var_61.push(new RoomLayout(true,80,"g"));
         var_61.push(new RoomLayout(true,74,"h"));
         var_61.push(new RoomLayout(false,416,"i"));
         var_61.push(new RoomLayout(false,320,"j"));
         var_61.push(new RoomLayout(false,448,"k"));
         var_61.push(new RoomLayout(false,352,"l"));
         var_61.push(new RoomLayout(false,384,"m"));
         var_61.push(new RoomLayout(false,372,"n"));
         var_61.push(new RoomLayout(true,416,"o"));
         var_61.push(new RoomLayout(true,352,"p"));
         var_61.push(new RoomLayout(true,304,"q"));
         var_61.push(new RoomLayout(true,336,"r"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_980 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_980.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_61.length)
         {
            _loc6_ = var_61[_loc4_];
            if(isAllowed(_loc6_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_61[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
         ...
         var_1727 = _navigator.data.hcMember;
      }
      ...
      public function dispose() : void
      {
         if(var_459)
         {
            var_459.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_459.reset();
            var_459 = null;
         }
      }
      ...
      {
         var_980.goBackToInitialState();
         var_980.input.textBackgroundColor = 4294967295;
         var_788 = var_61[0];
         if(var_1727 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_980.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_788.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1167 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1167 = true;
            _loc3_.y = 1;
