package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_491:IDropMenuWindow;
      
      private var var_2372:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 3)
         {
            return Tabs.const_601;
         }
         if(param1 == 4)
         {
            return Tabs.const_535;
         }
         return Tabs.const_191;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_491 == null ? 0 : int(var_491.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_491 == null)
         {
            var_491 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_491.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
