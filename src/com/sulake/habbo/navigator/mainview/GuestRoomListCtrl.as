package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_360:IScrollbarWindow;
      
      private var var_772:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         var_772 = new UserCountRenderer(_navigator);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1298 != null)
         {
            _loc2_ = var_1298.tags[0];
            var_1298.color = getBgColor(_loc2_);
         }
         var_1298 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_360 = IScrollbarWindow(var_20.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_2083 - _loc2_.stageX);
         var_2083 = _loc2_.stageX;
         var_2082 = _loc3_ > 2;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_47.numListItems)
         {
            if(var_47.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_47.getListItemAt(param2));
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_156,null,0);
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_118,null,0);
         refreshRoomName(param1,param2);
         var_772.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_260)
         {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               {
                  case RoomSettingsFlatInfo.const_118:
                     _navigator.passwordInput.show(_loc7_,_loc8_);
                     return;
                  case RoomSettingsFlatInfo.const_156:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1200,true);
