package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_170:IWindowContainer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2040 = new RoomThumbnailRenderer(param1);
         var_751 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_170,var_112.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_170.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_170.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_751.refreshTags(_loc1_,var_112.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2040.refreshThumbnail(_loc1_,var_112.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_170 == null)
         {
            var_170 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_170.visible = true;
         Util.hideChildren(var_170);
         refreshRoomName(var_170,var_112);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_170,!true ? getEventCtg(var_112.categoryId) : getRoomCtg(var_112.categoryId));
         refreshRoomDesc(var_170,var_112);
         refreshExtraCont();
         refreshInfo(var_170,"trading_allowed",var_112.allowTrading);
         refreshInfo(var_170,"doormode_doorbell",false);
         refreshInfo(var_170,"doormode_password",false);
         Util.moveChildrenToColumn(var_170,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_170.height = Util.getLowestPoint(var_170);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_214,Tabs.const_207,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
