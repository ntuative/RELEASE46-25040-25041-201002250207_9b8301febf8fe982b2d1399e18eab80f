package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2375:Dictionary;
      ...
      private var var_902:ISessionDataManager;
      
      private var var_901:RoomCreateViewCtrl;
      
      private var var_2040:RoomThumbnailRenderer;
      
      private var var_194:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_597:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_424:Tabs;
      
      private var var_276:MainViewCtrl;
      
      private var var_2196:Array;
      
      private var var_945:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_276 = new MainViewCtrl(this);
         var_597 = new RoomInfoViewCtrl(this);
         var_901 = new RoomCreateViewCtrl(this);
         var_2040 = new RoomThumbnailRenderer(this);
         var_945 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_424 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_276.startSearch(Tabs.const_214,Tabs.const_334,param1);
         var_276.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_194 != null)
         {
            var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_902)
         {
            var_902.release(new IIDSessionDataManager());
            var_902 = null;
         }
         if(_catalog)
         {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_168.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_194 != null)
         {
            var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_902 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_276.startSearch(Tabs.const_271,Tabs.const_191);
         var_424.getTab(Tabs.const_271).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_276.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
