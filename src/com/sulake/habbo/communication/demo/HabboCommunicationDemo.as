package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_162:HabboHotelView;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_294:
               _loc3_ = var_97.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_823:
               _loc3_ = var_97.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_899:
               _loc3_ = var_97.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_835:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1707)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_638 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_638);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_152);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      {
         var_969 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_190);
         param1.send(new VersionCheckMessageComposer(401,var_1161,var_1706));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1395,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_457.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_457.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1705);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1395,"/");
      ...
      {
         var_638 = var_97.getKey("sso.ticket",null);
         var_1161 = var_97.getKey("flash.client.url","");
         var_1706 = var_97.getKey("external.variables.txt","");
         if(var_162 == null)
         {
            var_162 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_638 != null)
         {
            var_71.mode = HabboConnectionType.const_407;
            var_71.initConnection(HabboConnectionType.const_228);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1411 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_556);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1705 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_71.mode)
         {
            case HabboConnectionType.const_407:
               _loc6_ = "";
               ...
               var_967 = _loc4_;
               var_162.loadBannerImage(_loc7_ + "?token=" + var_967,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1319:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1236:
               var_968 = generateRandomHexString(30);
               var_457 = new DiffieHellman(new BigInteger(var_97.getKey("connection.development.prime"),16),new BigInteger(var_97.getKey("connection.development.generator"),16));
               var_457.init(var_968);
               _loc8_ = var_457.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_162.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_967);
         ...
         var_457 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_968 = generateRandomHexString(30);
            var_457.init(var_968);
            _loc12_ = var_457.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_199);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(var_97).events.addEventListener(HabboConfigurationEvent.const_161,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_97,onRoomSessionEnded);
      }
