package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_795:uint = 0;
      
      private var var_659:IAssetLibrary;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_659.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_31,hotelViewLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_43,hotelViewLoadedHandler);
         }
         else
         {
            var_180 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_31,hotelViewLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_43,hotelViewLoadedCallbackHandler);
         }
         ++var_795;
      }
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_659.getAssetByName(_loc2_.assetName);
         if(param1.type == AssetLoaderEvent.const_43)
         {
            if(_events != null)
            {
         ...
         else if(param1.type == AssetLoaderEvent.const_31)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_365));
            }
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_43,bannerLoadedCallbackHandler);
      }
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_43,hotelViewLoadedCallbackHandler);
      }
      
      public function loadBannerImage(param1:String, param2:Function) : void
      {
         var _loc3_:AssetLoaderStruct = var_659.loadAssetFromFile("hotel_view_banner_" + var_795,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_31,bannerLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_43,bannerLoadedHandler);
         }
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_715));
            }
            var_180 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_31,bannerLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_43,bannerLoadedCallbackHandler);
         }
         ++var_795;
      }
      ...
      private function bannerLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_43,bannerLoadedHandler);
      }
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_43,hotelViewLoadedHandler);
      }
