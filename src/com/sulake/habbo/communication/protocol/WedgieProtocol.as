package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1252:uint = 1;
      
      public static const const_1192:uint = 2;
       
      
      private var var_786:IProtocolDecoder;
      
      private var var_979:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_979 = new WedgieEncoder();
         var_786 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1252)
            {
               _loc4_.position = 0;
               _loc6_ = var_786.getID(_loc4_);
