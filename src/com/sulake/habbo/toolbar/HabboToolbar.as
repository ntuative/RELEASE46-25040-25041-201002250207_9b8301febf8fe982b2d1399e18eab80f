package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_300.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_115,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_870,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_155,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_160,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_45,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_427,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_711,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_803,onHideWindowEvent);
         var_33 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_79));
      }
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_33 && _view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_45)
            {
