package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_749:int = 50;
      
      private static const const_1043:Number = 25;
      
      private static const const_1044:int = 50;
      
      private static const const_175:Boolean = true;
       
      
      private var var_540:Timer;
      
      private var var_965:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_965 = param2;
         var_540 = new Timer(const_1043);
         var_540.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_456.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_456.splice(_loc3_,1);
            var_455.splice(_loc3_,1);
         }
         var_455.push(param1.name);
         var_456.push(param2);
         param1.addEventListener(WindowEvent.const_410,windowEventListener);
         param1.addEventListener(WindowEvent.const_186,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_456[var_455.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_965.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_290.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_290.splice(var_290.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_965.getIconLoc(param1.iconId);
      ...
      {
         return var_455[var_456.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_290[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_539[_loc3_] = new Array();
            }
            if(var_539[_loc3_].indexOf(param1) < 0)
            {
               var_539[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_749 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_749 || param1.desktop.height - param1.y < const_1044;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_455[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_539[_loc3_].length)
                  {
                     repositionWindow(var_539[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
