package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_404:ToolbarBarMenuAnimator;
      ...
      public function getIconByMenuId(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_304.length)
         {
            _loc2_ = var_304[_loc3_];
            if(_loc2_ != null)
            {
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1312.length)
         {
            _loc2_ = var_716.indexOf(var_1312[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_304[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_849 + _loc3_);
                  _loc3_ += var_1311;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_404);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_304[var_716.indexOf(param1)];
      }
