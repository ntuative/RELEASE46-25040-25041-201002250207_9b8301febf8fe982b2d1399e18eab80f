package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_909:BitmapData = null;
      ...
      private var var_910:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_429,0,0,_loc4_,var_1572,var_910,var_909));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2215 = int(_config.getKey("interstitial.interval","30000"));
         var_2216 = int(_config.getKey("interstitial.show.time","5000"));
         var_1574 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1343 = _loc2_.imageUrl;
         var_1572 = _loc2_.clickUrl;
         if(var_1343 != "" && var_1572 != "")
         {
            _loc3_ = var_1343;
            ...
            _loc4_ = new URLRequest(var_1343);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1342 = _loc2_.imageUrl;
         var_2214 = _loc2_.clickUrl;
         var_735 = getTimer();
         if(var_1342 != "")
         {
            _loc3_ = var_1342;
            ...
            var_236.start();
            _loc4_ = new URLRequest(var_1342);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_31,interstitialLoaderEventHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_43,interstitialLoaderEventHandler);
         }
         else
         {
            stopInterstitial();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_473,0,0,param1.bitmapData,var_2214));
            var_735 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_909 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1574 > 0 && var_1573 >= var_1574)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_735;
         if(_loc1_ > var_2215)
         {
            ++var_1573;
      ...
      {
         var_300 = param2 as IHabboCommunicationManager;
         if(var_300 == null)
         {
            return;
         }
         _connection = var_300.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_375));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_910 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
