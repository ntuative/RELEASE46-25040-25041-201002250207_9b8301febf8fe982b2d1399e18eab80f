package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_158:Purse;
      
      private var var_2111:Boolean = true;
      ...
      private var var_203:PurchaseConfirmationDialog;
      
      private var var_493:IHabboSoundManager;
      
      private var var_303:CatalogViewer;
      ...
      private var var_2112:GiftWrappingConfiguration;
      ...
      private var var_1062:ClubGiftController;
      ...
      {
         return var_328.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_158.credits = _loc3_.balance;
         updatePurse();
         if(!var_2111 && var_493 != null)
         {
            var_493.playSound(HabboSoundTypesEnum.const_795);
         }
         var_2111 = false;
      }
      ...
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_74)
         {
            _loc3_ = var_328.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_75)
         {
            _loc3_ = var_328.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_203.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               var_1305 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_168.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_168.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2112 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_194 != null && _loc2_)
         {
            var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_194,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1062.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_158.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_158.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1062 == null)
         {
            var_1062 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_203 == null)
            {
               var_203 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_203.showOffer(this,param1,param2,param3,_loc7_);
      ...
      public function method_8(param1:Array) : void
      {
      ...
      {
         var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_162)
         {
            _loc3_ = var_168.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_303 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_303.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_158.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_158.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_158.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_158.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_303.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_158.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2110 && var_493 != null)
         {
            var_493.playSound(HabboSoundTypesEnum.const_996);
         }
         var_2110 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_303.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_303.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_303 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_303.habboCatalog = this;
      }
