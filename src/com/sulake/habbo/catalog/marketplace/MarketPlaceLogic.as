package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1635:int = 3;
      
      public const const_1547:int = 2;
      ...
      private var var_1729:MarketplaceItemStats;
      ...
      private var var_203:MarketplaceConfirmationDialog;
      ...
      {
         if(!var_326 || !_catalog || !_catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = var_326.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         showConfirmation(const_1490,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1734 || param1.furniTypeId != var_1731)
         {
            return;
         }
         var_1729 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            var_326.remove(parser.requestedOfferId);
            _visualization.listUpdatedNotify();
            if(_windowManager != null)
            {
         ...
         {
            updateItem = var_326.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               var_326.add(parser.offerId,updateItem);
            }
            var_326.remove(parser.requestedOfferId);
            showConfirmation(const_1547,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_646.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_646.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_446)
            {
               var_646.remove(_loc2_);
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1736 = _loc3_.creditsWaiting;
         var_646 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            _loc5_ = new MarketPlaceOfferData(_loc4_.offerId,_loc4_.furniId,_loc4_.furniType,_loc4_.price,_loc4_.status,_loc4_.method_1);
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            var_646.add(_loc4_.offerId,_loc5_);
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_203)
         {
            var_203 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_203.showConfirmation(param1,param2);
      }
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            _loc6_ = new MarketPlaceOfferData(_loc4_.offerId,_loc4_.furniId,_loc4_.furniType,_loc4_.price,_loc4_.status,_loc4_.method_1,_loc4_.offerCount);
            _loc6_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            var_326.add(_loc4_.offerId,_loc6_);
         }
         if(_visualization == null)
         {
            return;
      ...
      {
         requestOffers(var_1733,var_1732,var_1737,var_1730);
      }
