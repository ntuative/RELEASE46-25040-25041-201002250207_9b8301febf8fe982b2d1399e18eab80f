package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1410:uint = 4.294967295E9;
      ...
      private const const_1601:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_213.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_771;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_771,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1411) : uint(const_1410);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1403;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_74);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_647,var_80,var_962);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_213.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_771);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_536[var_186]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_535[var_187]);
         _catalog.purchaseProductAsGift(var_647,var_80,var_962,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_145:
               ...
               for each(_loc7_ in var_214)
               {
                  ...
                  if(_loc5_.length >= const_1601)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1661 = _loc3_.text;
               break;
            case WindowMouseEvent.const_48:
               showSuggestions(false);
               if(var_1148)
               ...
               break;
            case WindowKeyboardEvent.const_500:
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_203:
                  ...
                  break;
               case ProductTypeEnum.const_413:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1403 = _loc1_.stuffTypes;
            var_536 = _loc1_.boxTypes;
            var_535 = _loc1_.ribbonTypes;
            var_771 = var_1403[0];
            var_186 = var_536[0];
            var_187 = var_535[0];
            initColorGrid();
      ...
      private function method_2(param1:Boolean) : void
      {
         if(_window == null)
         {
            return;
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_213.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_213 == null)
         {
            var_213 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_451 == null)
         {
            var_451 = createWindow("suggestion_list_item") as IWindowContainer;
            var_451.procedure = suggestionsEventHandler;
         }
         if(var_213 == null || var_451 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_213.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_451.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
