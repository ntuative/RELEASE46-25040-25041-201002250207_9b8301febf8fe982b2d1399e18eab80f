package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_268:IBitmapWrapperWindow;
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_268.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
      }
      ...
      {
         var _loc8_:* = null;
         var_268 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
