package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_771:int = 0;
      
      public static const const_169:int = 5;
      
      private static const const_345:int = 1;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1530)
         {
            case RecyclerStatusMessageEvent.const_1148:
               var_270 = const_345;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_844:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1191:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return active && var_270 == const_345;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_169)
            {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1006:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1198:
