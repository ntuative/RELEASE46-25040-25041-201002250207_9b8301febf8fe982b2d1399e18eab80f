package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_181:Dictionary = new Dictionary();
      
      private static const const_773:Object = {"frontpage3":[7,8]};
      
      private static const const_1106:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_774:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      private static const const_1107:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      
      {
         const_181["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_181["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_181["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_181["collectibles"] = ["ctlg_collectibles_link"];
         const_181["club1"] = ["ctlg_text_5"];
      }
      ...
      {
         if(param1 < var_581.length)
         {
            return var_581[param1];
         }
         return "";
      }
      ...
      {
         if(param1 < var_880.length)
         {
            return var_880[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_581.length)
         {
            _loc2_ = String(var_581[param1]).replace("#","0x");
