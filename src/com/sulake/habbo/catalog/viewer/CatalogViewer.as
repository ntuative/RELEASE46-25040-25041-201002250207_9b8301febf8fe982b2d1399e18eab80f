package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1418:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_647 != null)
         {
            _container.removeChild(var_647.window);
            var_647.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1418);
         var_647 = _loc5_;
      ...
      {
         return var_647.dispatchWidgetEvent(param1);
      }
