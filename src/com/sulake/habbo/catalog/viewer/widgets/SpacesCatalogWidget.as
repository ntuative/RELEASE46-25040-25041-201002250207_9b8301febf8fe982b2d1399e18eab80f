package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1273:String = "FlatCreatedEvent";
      ...
      private var var_1272:String = "1.1";
      ...
      private var _floorType:String = "FlatCreatedEvent";
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_168.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_235 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_235];
                  if(_loc9_ != null)
                  {
                     var_1273 = _loc9_.@id;
                  }
         ...
         for each(_loc1_ in var_168.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_277];
               if(_loc11_ != null)
               {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_182:
               ...
               if(var_307 == _activeWallpaperPatterns.length)
               {
                  var_307 = 0;
               }
               var_235 = 0;
               ...
               for each(_loc8_ in var_168.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_731 = _loc8_.children().length();
                  }
               }
            ...
            case const_183:
               ...
               for each(_loc9_ in var_168.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_732 = _loc9_.children().length();
                  }
               }
            ...
            case const_184:
               ...
               for each(_loc10_ in var_168.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_733 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1273);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1331[var_309];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1272);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1273,var_1272,64,this,"window_romantic_wide");
