package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_10:ClubGiftController;
      ...
      private function updateList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(!var_10 || !window || !page)
         {
            return;
         }
         for each(_loc1_ in var_561)
         {
            _loc1_.dispose();
         }
         var_561.reset();
         _loc2_ = var_10.getOffers();
         if(!_loc2_)
         {
            return;
         }
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_561.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_195)
         {
            var_195 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_195)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_195.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_195.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         var _loc2_:XmlAsset = var_10.assets.getAssetByName(param1) as XmlAsset;
         ...
         return var_10.windowManager.buildFromXML(_loc3_);
      }
      ...
      private function updateInfo() : void
      {
         ...
         if(false)
         {
            ...
            var_10.localization.registerParameter(_loc2_,"amount",var_10.giftsAvailable.toString());
         }
         else if(false)
         {
            _loc2_ = "catalog.club_gift.days_until_next";
            var_10.localization.registerParameter(_loc2_,"days",var_10.daysUntilNextGift.toString());
         }
         else if(false)
         {
         ...
         _loc1_.text = var_10.localization.getKey(_loc2_);
      }
      ...
      {
         if(!param1 || !param2 || !var_561 || !var_10)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_561.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
         var_10.selectGift(_loc3_);
      }
