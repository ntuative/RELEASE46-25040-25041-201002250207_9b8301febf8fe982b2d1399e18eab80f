package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_828:MarketPlaceOfferData;
      
      private const const_1412:int = 1;
      
      private const const_1611:int = 40;
      
      private var var_474:IWindowContainer;
      
      private const const_1413:int = 2;
      ...
      private const const_1612:int = 10;
      ...
      private function showDetails(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc6_:String = param1.method_1 == 0 ? " - " : param1.method_1.toString();
      ...
      private function updateList() : void
      {
         ...
         if(!var_474)
         {
            ...
            var_474 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_474)
         {
            return;
         ...
         updateStatusDisplay(const_1413,_loc2_.length);
         if(!var_403)
         {
            var_403 = new Timer(25);
            var_403.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_829 = 0;
         populateList();
         var_403.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_561)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_474 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_474.clone() as IWindowContainer;
         ...
         if(_loc5_ != null)
         {
            ...
            _loc7_ = _loc7_.replace("%average%",param1.method_1 != 0 ? param1.method_1.toString() : " - ");
            _loc5_.text = _loc7_;
         }
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1412);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_402.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_403)
         {
            var_403.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_403 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_829 >= var_561.length)
            {
               return true;
            }
            addListItem(var_561.getWithIndex(var_829));
            ++var_829;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_828.offerId);
            }
            return;
         }
      ...
      public function updateStats() : void
      {
         ...
         if(_loc7_)
         {
            ...
            _loc7_.bitmap.draw(_loc6_.draw(_loc7_.width,_loc7_.height));
         }
         ...
         if(_loc8_)
         {
            if(_loc6_.available)
            {
               _loc9_ = "catalog.marketplace.offer_details.chart_title." + _loc5_.name;
               marketPlace.localization.registerParameter(_loc9_,"days",_loc1_.historyLength.toString());
            }
            else
            {
               _loc9_ = "catalog.marketplace.offer_details.chart_title.not_available";
            }
            _loc8_.text = marketPlace.localization.getKey(_loc9_);
         }
      }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_145)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_402));
            _loc7_.selection = 0;
         }
      }
