package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_2073:XML;
      
      private var var_292:IGridItem;
      
      private var var_1375:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_865:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_707[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_865 = new PrizeViewer();
         var_561 = new Map();
         var_707 = recycler.getPrizeTable();
         if(var_707 == null)
         {
            return;
         }
         ...
         var_2073 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_707[0].prizes.length > 0)
         {
            select(var_707[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_2073) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1375) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_865.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
