package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1008 != null)
         {
            var_1008.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1007 != null)
         {
            var_1007.removeEventListener(WindowKeyboardEvent.const_140,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1008 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1008 != null)
         {
            var_1008.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1007 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1007 != null)
         {
            var_1007.addEventListener(WindowKeyboardEvent.const_140,windowKeyEventProcessor);
         }
      }
