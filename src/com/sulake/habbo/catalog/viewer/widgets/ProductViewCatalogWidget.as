package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1253:IScrollbarWindow;
      
      protected var var_1375:XML;
      
      private var var_1254:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_569 != null)
         {
            var_569.visible = false;
            var_569.destroyGridItems();
         }
         if(var_1253 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1318.text = "${" + _loc3_.name + "}";
            var_1319.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1318.text = "${" + _loc2_.localizationId + "}";
            var_1319.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_421:
                  _loc4_ = var_1254.clone();
                  if(var_569 != null)
                  {
                     var_569.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_569,var_1253,var_1375);
                  }
                  break;
               ...
               case Offer.const_467:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_203:
                        ...
                        _loc4_ = new BitmapData(var_86.width,var_86.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_295,AvatarAction.const_704);
                              _loc13_.appendAction(AvatarAction.const_597,_loc6_.productClassId);
      ...
      {
         var_1318 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1319 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1505 = new Point(var_86.x,var_86.y);
         var_569 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1253 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_569 == null)
         {
         ...
         var_1254 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_86);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_31,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_86.bitmap = new BitmapData(var_86.width,var_86.height,true,16777215);
         }
         var_86.bitmap.fillRect(var_86.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_86.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_86.invalidate();
         var_86.x = var_1505.x;
         var_86.y = var_1505.y;
         if(param2 != null)
