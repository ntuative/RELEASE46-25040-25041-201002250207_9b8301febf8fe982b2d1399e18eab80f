package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_564[var_1025] as Array;
      ...
      {
         var _loc2_:Offer = var_564[var_1025][var_1925];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_445 || _loc1_.pricingModel == Offer.const_467)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_75 || _loc3_.productType == ProductTypeEnum.const_74)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1024.indexOf(_loc5_) == -1)
                        {
                           var_1024.push(_loc5_);
                           var_564.push(new Array());
                        }
                        _loc6_ = var_1024.indexOf(_loc5_);
                        (var_564[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_564)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_564)
         {
            if(var_1925 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1925] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1025 = var_932.getGridItemIndex(param1.view);
