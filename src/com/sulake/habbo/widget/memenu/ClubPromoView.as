package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_368:String = "CPV_MODE_TRIAL";
      
      public static const const_1272:String = "CPV_MODE_FULL";
      ...
      private const const_1099:String = "avatareditor_club_promo_image";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_ = _widget.assets.loadAssetFromFile(const_1099,_loc7_,"image/png");
            _loc8_.addEventListener(AssetLoaderEvent.const_31,onPromoImageReady);
         }
         if(param3 == const_368)
         {
      ...
      private function setPromoImage() : Boolean
      {
         ...
         if(_widget.assets.hasAsset(const_1099))
         {
            _loc2_ = _widget.assets.getAssetByName(const_1099) as BitmapDataAsset;
            if(!_loc2_)
            {
               return false;
            }
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_727,_loc2_.text,var_623 == const_368);
