package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_859:IWindow;
      
      private var var_861:IWindow;
      
      private var var_423:Number;
      
      private var var_860:ITextWindow;
      
      private var var_171:IWidgetAvatarEffect;
      
      public function EffectView()
      {
         super();
         var_177 = new Timer(1000);
         var_177.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_859 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_171.duration);
               var_859.width = _loc2_ * var_423;
            }
            else
            {
               var_859.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_861 = _window.findChildByName("effect_hilite");
            var_861.visible = false;
         }
         var_860 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_859 = _window.findChildByName("loader_bar");
         if(var_859 != null)
         {
            var_423 = var_859.width;
            var_177.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_171.icon);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_177.stop();
            var_177.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_177 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_860 != null)
         {
            var_860.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_860.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
