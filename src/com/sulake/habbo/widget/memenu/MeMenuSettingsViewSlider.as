package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_838:MeMenuSettingsView;
      
      private var var_2354:int;
      
      private var var_547:BitmapData;
      
      private var var_991:Number = 1;
      
      private var var_1435:int;
      
      private var var_653:Number = 0;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_838.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_547 != null)
            {
               ...
               var_1435 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1435 * (Number(param1 - var_653) / (var_991 - var_653)));
      }
      ...
      {
         return param1 / var_1435 * (var_991 - var_653) + var_653;
      }
   }
}
