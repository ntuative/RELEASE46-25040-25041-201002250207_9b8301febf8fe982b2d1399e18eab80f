package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_338:int = 10;
      
      private static const const_1052:Number = 18;
      
      private static const const_1399:Number = 10;
      
      private static const const_1400:Number = 8;
      ...
      private var var_189:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_985,var_986,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_985,var_986,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1175 = param1.chatType;
         var_985 = param1.userId;
         var_792 = param1.userName;
         var_986 = param1.userCategory;
         _message = param1.text;
         var_1174 = param1.userX;
         var_189 = param1.userImage;
         var_984 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_85,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         switch(var_1175)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_273:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_247:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_189 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_189.height);
         }
         ...
         if(var_189 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_189.width;
               _loc28_.height = var_189.height;
               _loc28_.bitmap = new BitmapData(var_189.width,var_189.height,true,0);
               _loc28_.bitmap.copyPixels(var_189,var_189.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_385 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_189.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_984 != 0)
            {
               _loc30_ = uint(var_984 >> 16 & 255);
               _loc31_ = uint(var_984 >> 8 & 255);
               _loc32_ = uint(var_984 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_338;
            }
            else
            {
               _loc19_.text = var_792 + ":";
               _loc19_.y += var_385;
               _loc19_.width = _loc19_.textWidth + const_338;
               _width += _loc19_.textWidth + const_338;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1175 == RoomWidgetChatUpdateEvent.const_273)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_792);
            }
            else if(var_1175 == RoomWidgetChatUpdateEvent.const_247)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_792);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_338 + _loc20_.textWidth + const_487;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_985,var_986,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_985,var_986,_roomId,_roomCategory,param1);
      }
