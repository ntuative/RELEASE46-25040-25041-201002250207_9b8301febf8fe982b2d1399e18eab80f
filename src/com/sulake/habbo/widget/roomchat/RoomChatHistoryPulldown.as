package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_747:int = 250;
      ...
      private var var_1407:BitmapData;
      ...
      private var var_1677:int = 30;
      
      private var var_33:int = -1;
      
      private var var_1679:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_37 = param3;
         var_1681 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1407 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1678 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1406 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1405 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1679 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1682 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_69 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,param3.width,param3.height - const_71),null,0,0) as IBitmapWrapperWindow;
         var_37.addChild(var_69);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_38,new Rectangle(0,0 - const_71,param3.width,const_71),null,0) as IWindowContainer;
         var_37.addChild(_window);
         var_98 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_408,HabboWindowStyle.const_39,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_71),null,0) as IRegionWindow;
         if(var_98 != null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_348:
               var_69.blend += param1 / const_747;
               _window.blend += param1 / const_747;
               if(false)
               {
                  state = const_283;
               }
               break;
            case const_760:
               var_69.blend = 0 - param1 / const_748;
               _window.blend = 0 - param1 / const_748;
               if(true)
               {
                  state = const_221;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_98 != null)
         {
            var_98.x = 0;
            var_98.y = 0 - const_71;
            var_98.width = 0 - var_1677;
         }
         if(var_69 != null)
         {
            var_69.rectangle = var_37.rectangle;
            var_69.height = 0 - const_71;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1680 == _window.width)
         {
            return;
         }
         var_1680 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1681.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1407.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1407.clone(),_loc9_);
