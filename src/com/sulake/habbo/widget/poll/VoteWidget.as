package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_684:Array = null;
      ...
      private var var_1296:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1296 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_106,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_128,showVoteResult);
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(var_47.scrollableRegion.height - 0,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         var_47 = _window.findChildByName("choices") as IItemListWindow;
         if(var_47 == null)
         {
            return false;
         }
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1927;
         if(_loc2_ > var_1296)
         {
            vote();
            return;
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(var_47.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_47.numListItems)
         {
            _loc4_ = var_47.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_47.numListItems)
         {
            _loc2_ = var_47.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_106,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_128,showVoteResult);
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1296 - param1) / 1000,0);
