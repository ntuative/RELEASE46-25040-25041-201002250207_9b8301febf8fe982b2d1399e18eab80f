package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_677[var_1011] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_295)
         {
            ...
            var_295 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_295.center();
            var_295.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1011;
         if(var_1011 < var_677.length)
         {
            _loc1_ = var_677[var_1011] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_677.length);
                  _loc2_.text = _loc6_;
               }
