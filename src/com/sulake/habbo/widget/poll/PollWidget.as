package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_102,showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_60,showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_108,showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_102,showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_60,showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_108,showPollContent);
      }
