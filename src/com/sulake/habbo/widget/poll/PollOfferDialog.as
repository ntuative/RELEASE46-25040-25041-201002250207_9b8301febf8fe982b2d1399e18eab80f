package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_239:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_698:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1134:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_33 = const_1134;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_506,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_33 = const_698;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_477,_id));
