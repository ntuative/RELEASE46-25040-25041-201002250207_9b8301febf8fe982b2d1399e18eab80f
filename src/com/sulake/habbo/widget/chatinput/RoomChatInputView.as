package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1414:int = 5;
      ...
      private static const const_1103:int = 40;
      ...
      private var var_423:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1061 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2098 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2097 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_713 = new Timer(1000,1);
         var_713.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_877 = new Timer(5000,1);
         var_877.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_140,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_42,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_145,onInputChanged);
         _window.addEventListener(WindowEvent.const_410,onWindowMoved);
         var_1303 = true;
         var_136 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2099 = _loc2_.width + const_487 + _loc6_.width + const_1102;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1103,_loc8_.width) + const_487);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1061 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_136 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_423);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_423);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_492);
