package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_63,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_349,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_424,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_457,onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_125,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_63,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_63,onObjectUpdate);
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_349,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_424,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_457,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_63,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_63:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_349:
               if(!var_210)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_424:
               if(!var_210)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_457:
               if(!var_210)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_561,var_145);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_56,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1036,const_1035,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_182 != null)
         {
            _loc4_.caption = var_182;
         }
