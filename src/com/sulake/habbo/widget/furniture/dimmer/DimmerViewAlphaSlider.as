package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_93 && param1.type != WindowMouseEvent.const_455)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1435 * (var_991 - var_653)) + var_653;
      }
   }
}
