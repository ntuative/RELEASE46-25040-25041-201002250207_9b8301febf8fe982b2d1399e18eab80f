package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_441:ChooserView;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_570,onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_125,onUpdateFurniChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_549,onUpdateFurniChooser);
      ...
      {
         if(var_441 == null || !var_441.isOpen())
         {
            return;
         }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(var_441 == null)
         {
            var_441 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         var_441.populate(param1.items,param1.isAnyRoomController);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_570,onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_125,onUpdateFurniChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_549,onUpdateFurniChooser);
      }
   }
}
