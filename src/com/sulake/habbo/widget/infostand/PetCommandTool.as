package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_323:IFrameWindow;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_952 = new Map();
         var_322 = new Timer(const_1600);
         var_322.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_654,param1);
      ...
      {
         var_952.remove(param1);
         var_952.add(param1,param2);
         if(param1 != var_628)
         {
            return;
         }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_323 == null)
         {
            ...
            var_323 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_323 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_323.x = 200;
            var_323.procedure = onInfoWindowProcedure;
         }
         else
         {
      ...
      {
         var _loc2_:Array = var_952.getValue(var_628) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_459,var_628));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_553,var_628,var_1648 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_952.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
      ...
      private function createCommandWindow() : void
      {
         ...
         var_41.setParamFlag(WindowParam.const_83,true);
         var_41.context.getDesktopWindow().addEventListener(WindowEvent.const_42,onWindowDesktopResized);
