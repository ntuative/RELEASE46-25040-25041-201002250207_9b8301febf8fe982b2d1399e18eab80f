package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1615:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1614:String = "level";
      
      private var var_105:IItemListWindow;
      
      private const const_1613:String = "energy";
      
      private var var_1255:Map;
      
      private const const_1617:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1619:uint = 3355443;
      
      private var var_233:IBorderWindow;
      
      private const const_1621:int = 158;
      
      private const const_1616:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_263:PetCommandTool;
      
      private const const_1620:uint = 11184810;
      
      private const const_1618:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_233 != null)
         {
            var_105 = var_233.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_105.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(var_105 == null || var_233 == null || var_60 == null)
         {
            return;
         }
         var_60.width = var_60.scrollableRegion.width;
         var_60.visible = false;
         var_105.height = var_105.scrollableRegion.height;
         var_233.height = NaN;
         _window.width = Math.max(var_233.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_263 == null)
         {
            var_263 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1255.getValue(var_628) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_263.showWindow(true);
            var_263.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1614,param1.level,param1.levelMax);
         updateStateElement(const_1618,param1.experience,param1.experienceMax);
         updateStateElement(const_1613,param1.energy,param1.energyMax);
         updateStateElement(const_1617,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_628 = param1.id;
         var_1255.remove(param1.id);
         var_1255.add(param1.id,param1);
         if(var_263 && var_263.isVisible() && param1.isOwnPet)
         {
            var_263.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_263.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_403,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1621,const_1616,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1620);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1619);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1615);
         return _loc5_;
      }
