package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1631:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1330 != null && var_1330.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_111);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_896 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_896 += param1.height + const_1631;
            return fit(param1);
         }
         param1.offset(_offsetX,var_896);
