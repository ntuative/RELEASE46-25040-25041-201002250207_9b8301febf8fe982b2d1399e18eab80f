package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_7:IRoomCreator = null;
      
      private var var_1026:int = -1000000000;
      ...
      private function onItemUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:LegacyWallGeometry = var_7.getLegacyGeometry(_loc4_,_loc5_);
         if(var_7 == null || _loc6_ == null)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            ...
            var_7.updateObjectWallItem(_loc4_,_loc5_,_loc7_.id,_loc8_,_loc9_,_loc7_.state,_loc7_.data);
         }
      }
      ...
      private function onUseObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is UseObjectMessageEvent)
         {
            ...
            var_7.updateObjectUserState(_loc2_.roomId,_loc2_.roomCategory,_loc2_.userId,_loc3_);
         }
      }
      ...
      private function onDance(param1:IMessageEvent) : void
      {
         ...
         var_7.updateObjectUserState(_loc3_.roomId,_loc3_.roomCategory,_loc3_.userId,_loc4_);
      }
      ...
      private function onHeightMap(param1:IMessageEvent) : void
      {
         ...
         var_7.setTileHeightMap(_loc4_,_loc5_,_loc8_);
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         var_7.updateObjectUserState(_loc2_.roomId,_loc2_.roomCategory,_loc2_.id,_loc3_);
      }
      ...
      private function addPassiveObject(param1:int, param2:int, param3:PublicRoomObjectMessageData) : void
      {
         ...
         var_7.addObjectFurnitureByName(param1,param2,_loc6_,param3.type,_loc4_,_loc5_,0,"");
      }
         ...
         if(var_7 != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               while(_loc5_ < _loc4_)
               {
                  ...
                  var_7.setRoomObjectAlias(_loc6_,_loc7_);
                  _loc5_++;
               }
            }
         }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = _loc3_.roomId;
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:IRoomObject = var_7.getObjectRoom(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_816,_loc3_.status);
         }
      }
      ...
      private function addActiveObject(param1:int, param2:int, param3:ObjectMessageData) : void
      {
         ...
         {
            var_7.addObjectFurnitureByName(param1,param2,param3.id,param3.staticClass,_loc4_,_loc5_,param3.state,param3.data,param3.extra);
         }
         else
         {
            var_7.addObjectFurniture(param1,param2,param3.id,param3.type,_loc4_,_loc5_,param3.state,param3.data,param3.extra,param3.expiryTime);
         }
      }
      ...
      private function isPublicRoom(param1:int, param2:int) : Boolean
      {
         if(var_7)
         {
            return var_7.isPublicRoom(param1,param2);
         }
         return false;
      }
      ...
      private function onObjectDataUpdate(param1:IMessageEvent) : void
      {
         ...
         var_7.updateObjectFurniture(_loc4_,_loc5_,_loc6_,null,null,_loc7_,_loc8_);
      }
      ...
      private function onItemRemove(param1:IMessageEvent) : void
      {
         ...
         var_7.disposeObjectWallItem(_loc3_.roomId,_loc3_.roomCategory,_loc3_.itemId);
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = _loc3_.roomId;
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:IRoomInstance = var_7.getRoom(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_728);
         var _loc8_:int = 0;
         while(_loc8_ < _loc3_.userUpdateCount)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               var_7.updateObjectUser(_loc4_,_loc5_,_loc9_.id,_loc11_,_loc13_,_loc12_,_loc9_.dirHead);
               _loc14_ = "null";
               _loc15_ = "";
               _loc16_ = new RoomObjectAvatarFlatControlUpdateMessage(null);
               var_7.updateObjectUserState(_loc4_,_loc5_,_loc9_.id,_loc16_);
               _loc17_ = false;
               _loc18_ = false;
               for each(_loc19_ in _loc9_.actions)
               {
                  switch(_loc19_.actionType)
                  {
                     ...
                     case "sign":
                        ...
                        var_7.updateObjectUserState(_loc4_,_loc5_,_loc9_.id,_loc21_);
                        continue;
                     case "gst":
                        _loc22_ = new RoomObjectAvatarPetGestureUpdateMessage(_loc19_.actionParameter);
                        var_7.updateObjectUserState(_loc4_,_loc5_,_loc9_.id,_loc22_);
                        continue;
                     default:
               ...
               var_7.updateObjectUserState(_loc4_,_loc5_,_loc9_.id,_loc20_);
            }
            _loc8_++;
         }
      }
      ...
      private function onRoomDisconnected(param1:IMessageEvent) : void
      {
         ...
         if(var_7 != null)
         {
            ...
            var_7.disposeRoom(_loc4_,_loc5_);
         }
      }
      ...
      private function addWallItem(param1:int, param2:int, param3:ItemMessageData) : void
      {
         ...
         var _loc4_:LegacyWallGeometry = var_7.getLegacyGeometry(param1,param2);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         var_7.addObjectWallItem(param1,param2,param3.id,param3.type,_loc5_,_loc6_,param3.state,param3.data);
      }
      ...
      private function onItemDataUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = _loc3_.roomId;
         var _loc5_:int = _loc3_.roomCategory;
         var_7.updateObjectWallItemData(_loc4_,_loc5_,_loc3_.id,_loc3_.method_3);
      }
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         var_76.initializeTileMap(_loc7_,_loc8_);
         var _loc9_:* = -1;
         var _loc10_:* = -1;
         var _loc11_:* = 0;
         var _loc12_:* = 0;
         var _loc13_:Boolean = isPublicRoom(_loc4_,_loc5_);
         var _loc14_:TileHeightMap = var_7.getTileHeightMap(_loc4_,_loc5_);
         if(_loc14_ == null)
         {
            return;
         }
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc20_ < _loc7_)
            {
               ...
               var_76.setTileHeight(_loc20_,_loc15_,_loc21_);
               _loc20_++;
            }
            _loc15_++;
         }
         if(!_loc13_)
         {
            var_76.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_);
         }
         ...
         var_76.initializeFromTileData(_loc16_);
         if(!_loc13_)
         {
            var_76.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_ + var_76.wallHeight);
         }
         _loc6_.scale = _loc3_.scale;
         _loc6_.initialize(_loc7_,_loc8_,var_76.floorHeight);
         ...
         while(_loc17_ >= 0)
         {
            ...
            while(_loc23_ >= 0)
            {
               _loc6_.setTileHeight(_loc23_,_loc17_,var_76.getTileHeight(_loc23_,_loc17_));
               _loc23_--;
            }
            _loc17_--;
         }
         var _loc18_:XML = var_76.getXML();
         var _loc19_:XML = <dimensions minX="{var_76.minX}" maxX="{var_76.maxX}" minY="{var_76.minY}" maxY="{var_76.maxY}"/>;
         ...
         var_7.initializeRoom(_loc4_,_loc5_,_loc18_);
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new AvatarEffectMessageEvent(method_7));
      ...
      private function onRoomProperty(param1:IMessageEvent) : void
      {
         ...
         if(var_7 != null)
         {
            var_7.updateObjectRoom(_loc4_,_loc5_,_loc7_,_loc8_,_loc9_);
         }
      }
      ...
      private function onPetExperience(param1:PetExperienceEvent) : void
      {
         ...
         var_7.updateObjectUserState(_loc2_.roomId,_loc2_.roomCategory,_loc2_.petRoomIndex,_loc3_);
      }
      ...
      private function onChat(param1:IMessageEvent) : void
      {
         ...
         var_7.updateObjectUserState(_loc2_.roomId,_loc2_.roomCategory,_loc2_.userId,_loc4_);
      }
      ...
      private function onObjectUpdate(param1:IMessageEvent) : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            var_7.updateObjectFurniture(_loc4_,_loc5_,_loc6_.id,_loc7_,_loc8_,_loc6_.state,_loc6_.data,_loc6_.extra);
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(var_7 != null)
         {
            var_7.setWorldType(_loc3_.roomId,_loc3_.roomCategory,_loc4_);
         }
         if(var_1235)
         {
      ...
      private function onOneWayDoorStatus(param1:IMessageEvent) : void
      {
         ...
         var_7.updateObjectFurniture(_loc4_,_loc5_,_loc6_,null,null,_loc7_,"");
      }
      ...
      private function onUserRemove(param1:IMessageEvent) : void
      {
         ...
         var_7.disposeObjectUser(_loc3_.roomId,_loc3_.roomCategory,_loc3_.id);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.getUserCount())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               var_7.addObjectUser(_loc4_,_loc5_,_loc7_.id,_loc8_,_loc9_,_loc7_.dir,_loc7_.userType);
               if(_loc7_.webID == var_1928)
               {
                  var_7.setOwnUserId(_loc4_,_loc5_,_loc7_.id);
               }
               _loc10_ = new RoomObjectAvatarFigureUpdateMessage(_loc7_.figure,_loc7_.subType);
               var_7.updateObjectUserState(_loc4_,_loc5_,_loc7_.id,_loc10_);
            }
            _loc6_++;
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            var_7.updateObjectFurniture(_loc3_,_loc4_,_loc2_.id,null,null,1,null);
            var_7.updateObjectFurniture(_loc3_,_loc4_,_loc2_.id,null,null,2,null);
            ...
            while(_loc7_ < _loc5_.length)
            {
               ...
               if(_loc8_ != null)
               {
                  ...
                  var_7.updateObjectFurnitureLocation(_loc3_,_loc4_,_loc8_.id,_loc6_ as RoomObjectUpdateMessage);
               }
               _loc7_++;
            }
            if(_loc2_.avatar != null)
            {
               ...
               var_7.updateObjectUser(_loc3_,_loc4_,_loc9_.id,_loc9_.loc,_loc9_.target);
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_849:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_907:
                     _loc10_ = "std";
               }
               _loc11_ = new RoomObjectAvatarPostureUpdateMessage(_loc10_);
               var_7.updateObjectUserState(_loc3_,_loc4_,_loc9_.id,_loc11_);
            }
         }
      }
      ...
      private function onHeightMapUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = _loc3_.roomId;
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:TileHeightMap = var_7.getTileHeightMap(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
