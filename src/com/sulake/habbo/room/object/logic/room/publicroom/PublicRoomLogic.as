package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_293,"");
         _loc2_.setString(RoomObjectVariableEnum.const_595,"");
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_985:
                  _loc2_.setString(RoomObjectVariableEnum.const_293,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_595,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_435,Number(true));
                  var_992 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_919);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_383)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_595);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_230,_loc5_,_loc6_,_loc7_));
            ...
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_383)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_281,_loc5_,_loc6_));
               }
         }
      }
   }
