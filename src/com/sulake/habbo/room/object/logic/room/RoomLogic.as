package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1451:int = 1500;
      
      private var var_1452:int = 255;
      
      private var var_1453:int = 255;
      
      private var var_1202:uint = 16777215;
      
      private var var_1002:uint = 16777215;
      
      protected var var_76:RoomPlaneParser = null;
      
      private var var_806:int = 0;
      
      private var var_1329:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_662:
                  _loc2_.setString(RoomObjectVariableEnum.const_633,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_620:
                  _loc2_.setString(RoomObjectVariableEnum.const_733,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_514:
                  _loc2_.setString(RoomObjectVariableEnum.const_645,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_476:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_204)
                  {
                     _loc8_ = "null";
                  }
                  var_383.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_502:
                  _loc7_ = var_383.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_383.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_998,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_963,int(_loc5_.bgOnly));
            var_1202 = _color;
            var_1452 = var_1329;
            var_1002 = _loc11_;
            var_1453 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_956,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_585,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_76.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_100,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1337,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1176,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1273,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_100,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_139)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_146 || _loc13_ == RoomPlaneData.const_246)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_806)
         {
            ...
            {
               _loc7_ = var_1202 >> 16 & 255;
               _loc8_ = var_1202 >> 8 & 255;
               _loc9_ = var_1202 & 255;
               _loc10_ = var_1002 >> 16 & 255;
               _loc11_ = var_1002 >> 8 & 255;
               _loc12_ = var_1002 & 255;
               _loc13_ = (_loc2_ - var_806) / var_1451;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1452 + (var_1453 - var_1452) * _loc13_;
               _color = _loc3_;
               var_1329 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_585,_loc3_);
         }
      }
   }
}
