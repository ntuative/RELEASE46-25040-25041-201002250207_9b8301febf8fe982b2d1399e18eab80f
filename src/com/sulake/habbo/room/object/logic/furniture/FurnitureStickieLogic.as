   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_399,_loc3_,_loc4_);
                  if(_loc5_ != null)
                  {
      ...
      private function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_195,_loc3_ + 1);
         }
      }
   }
}
