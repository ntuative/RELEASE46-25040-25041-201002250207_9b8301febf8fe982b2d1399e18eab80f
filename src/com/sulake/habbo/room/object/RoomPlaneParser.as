package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_725:Number = 0;
      
      private var var_344:int = 0;
      
      private var var_342:int = 0;
      
      private var var_1294:Number = 0;
      ...
      private var var_345:int = 0;
      
      private var var_113:Number = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_909;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_872);
         addPlane(RoomPlaneData.const_146,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_146,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_113) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_146,Vector3d.sum(param1,Vector3d.product(param3,-var_113 / param3.length)),Vector3d.product(param3,(param3.length + var_113) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_872 / param2.length);
      ...
      {
         if(param1 == null || var_104 == null || param1 == var_104)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > var_104.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = var_104[_loc3_] as Array;
      ...
      private function getTileHeightInternal(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = var_104[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(var_104);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         var_725 = getFloorHeight(var_104);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            _loc4_ = var_104[param2] as Array;
            ...
            {
               if(param1 == var_342 || param1 == var_343)
               {
                  _loc5_ = false;
                  _loc6_ = var_344;
                  while(_loc6_ < var_345)
                  {
               ...
               if(param2 == var_344 || param2 == var_345)
               {
                  _loc7_ = false;
                  _loc8_ = var_342;
                  while(_loc8_ < var_343)
                  {
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_139,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_139,_loc13_,new Vector3d(0,0,-var_113),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,var_113,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,var_113,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_139,_loc13_,new Vector3d(0,0,-var_113),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,var_113,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,var_113,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_139,_loc13_,new Vector3d(0,0,-var_113),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,var_113,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,var_113,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_139,_loc13_,new Vector3d(0,0,-var_113),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,var_113,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,var_113,param11);
                  }
               }
            }
         }
