package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1093:Number = 30;
      ...
      private var var_696:Vector3d;
      
      private var var_1156:Number;
      
      private var var_2042:Number;
      ...
      {
         var_696 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1156 = param3;
         var_2042 = param4 * 0 * 2 / 360;
         var_1511 = param5 * 0 * 2 / 360;
         _height = param6;
         var_849 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1156 * Math.cos(var_849 + var_1511);
         var _loc4_:Number = var_1156 * Math.sin(var_849 + var_1511);
         var _loc5_:Number = _height;
         var_696.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_696.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_696.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_696.add(param1);
         }
