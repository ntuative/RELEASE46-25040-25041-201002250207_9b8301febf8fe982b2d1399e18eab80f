package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1430:String = null;
      ...
      private var var_1328:Boolean = true;
      ...
      protected var var_2269:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_592[param1] = _loc3_;
            var_593[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1430 != null && var_1430.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2270,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2177 != param1 || var_2176 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_592[_loc3_] = "";
               var_593[_loc3_] = false;
               _loc3_--;
            }
            var_2177 = param1;
            var_2176 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2175 != param1 || var_2174 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2270 = _loc3_.getNumber(RoomObjectVariableEnum.const_195);
            ...
            var_1430 = _loc3_.getString(RoomObjectVariableEnum.const_297);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_282 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2269)
         {
