package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_778:int = 15;
      
      private static const const_1115:int = 2;
      
      private static const const_343:int = 2;
      
      private static const const_777:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1071[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1070[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1071 = new Array();
         var_1071.push(Math.random() * _loc2_ * 1.5);
         var_1071.push(Math.random() * _loc2_ * 1.5);
         var_1072 = new Array();
         var_1072.push(1);
         var_1072.push(-1);
         var_1069 = new Array();
         var_1069.push(const_1115);
         var_1069.push(const_1116);
         var_1070 = new Array();
         var_1070.push(getRandomAmplitudeFactor());
         var_1070.push(getRandomAmplitudeFactor());
      }
