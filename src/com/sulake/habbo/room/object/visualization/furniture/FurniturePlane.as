package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_266.assign(param2);
         var_265 = new Vector3d();
         var_265.assign(param3);
         var_571 = new Vector3d();
         var_571.assign(param2);
         var_572 = new Vector3d();
         var_572.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2041)
         {
            if(!param1)
            {
               var_266.assign(var_571);
               var_265.assign(var_572);
            }
            else
            {
               var_266.assign(var_571);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_72 == null && var_800 != null || var_266 == null || var_265 == null || var_464 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1267)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1046 || _loc4_.y != var_1757 || _loc4_.z != var_1753 || param1.scale != var_1755))
            {
               var_1046 = _loc4_.x;
               var_1757 = _loc4_.y;
               var_1753 = _loc4_.z;
