package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1550:int = 16777216;
      
      public static const const_1559:int = 1;
       
      
      private var var_2340:int = 69069;
      
      private var var_1293:int = 1;
      
      private var var_2339:int = 5;
      
      private var var_1525:int = 16777216;
      ...
      public static function method_11(param1:int, param2:int) : Array
      {
         if(_randomizer == null)
         {
            _randomizer = new Randomizer();
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1525 * param2);
      }
      ...
      {
         var _loc1_:int = var_2340 * var_1293 + var_2339;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
