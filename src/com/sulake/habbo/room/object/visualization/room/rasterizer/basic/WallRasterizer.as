package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class WallRasterizer extends PlaneRasterizer
   {
      ...
      private function parseWalls(param1:XML) : void
      {
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               if(var_346.getValue(_loc5_) == null)
               {
                  var_346.add(_loc5_,_loc7_);
               }
               else
               {
                  _loc7_.dispose();
      ...
      {
         var _loc13_:WallPlane = var_346.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_346.getValue(const_738);
         }
         if(_loc13_ == null)
         {
            return null;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_346.length)
            {
               _loc2_ = var_346.getWithIndex(_loc1_) as WallPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
