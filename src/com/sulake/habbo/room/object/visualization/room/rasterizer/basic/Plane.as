package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_740:PlaneVisualization = null;
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_740 = var_426.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_740 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_426 != null)
         {
            ...
            {
               _loc1_ = var_426.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
