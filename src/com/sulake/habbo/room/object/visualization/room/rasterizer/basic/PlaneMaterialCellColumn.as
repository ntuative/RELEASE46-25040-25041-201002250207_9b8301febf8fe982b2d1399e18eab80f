package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public static const const_220:int = 3;
      ...
      private var var_770:Vector3d = null;
      
      private var var_26:BitmapData;
      
      private var var_1402:int = 1;
      
      private var var_1147:Boolean = true;
      ...
      private function renderRepeatLast(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_34,_loc3_,true,param1);
         _loc2_ = var_34["-1"] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         while(_loc7_ < -1)
         {
            _loc2_ = var_34[_loc7_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         if(false)
         {
            _loc2_ = var_34[0] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
               _loc6_ = _loc2_.getHeight(param1);
               if(_loc6_ > 0)
      ...
      private function renderRepeatNone(param1:IVector3d) : void
      {
         ...
         renderCells(var_34,0,true,param1);
      }
      ...
      private function renderRepeatFirst(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_34,_loc3_,false,param1);
         _loc2_ = var_34[0] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         while(_loc9_ < 0)
         {
            _loc2_ = var_34[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
      ...
      private function method_4(param1:IVector3d) : void
      {
         if(var_26 == null)
         {
            return;
         }
         var _loc2_:int = getCellsHeight(var_34,param1);
         var _loc3_:int = 0;
      ...
      {
         var _loc3_:int = 0;
         if(var_1402 == const_546)
         {
            _loc3_ = getCellsHeight(var_34,param2);
            param1 = _loc3_;
         }
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.height == param1 && Vector3d.isEqual(var_770,param2))
               {
                  return var_26;
               }
               var_26.dispose();
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_34.length)
            {
               _loc2_ = var_34[_loc1_] as PlaneMaterialCell;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
