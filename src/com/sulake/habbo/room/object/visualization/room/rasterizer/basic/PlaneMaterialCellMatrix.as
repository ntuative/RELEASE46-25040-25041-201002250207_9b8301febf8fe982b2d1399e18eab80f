package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1211:int = const_311;
      ...
      public static const const_235:int = const_98;
      ...
      private function method_4(param1:BitmapData, param2:Array) : int
      {
         var _loc6_:* = null;
         if(param2 == null || param2.length == 0 || param1 == null)
         {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1401 == const_98)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_450);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_450,var_26.width,var_450);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_770,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_450,param6,param7);
                     return param1;
                  }
                  return var_26;
               }
         ...
         switch(var_1402)
         {
            ...
            case const_681:
               ...
               break;
            default:
               _loc10_ = method_4(var_26,_loc8_);
         }
         var_450 = _loc10_;
         if(param1 != null)
         {
