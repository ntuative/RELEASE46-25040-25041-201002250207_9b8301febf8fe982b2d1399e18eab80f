package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1068:Point = null;
      
      private var var_499:Array;
      
      private var var_1067:LayoutRasterizerData = null;
      ...
      {
         var_500 = true;
         var _loc3_:int = var_352.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_352.push(param1);
            var_498.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1066 = param1;
         var _loc3_:LayoutRasterizerData = var_61.getValue(var_719);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1322 = RoomObjectVariableEnum.const_822;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1322 = RoomObjectVariableEnum.const_880;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1066 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1066 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1066 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1066 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1322);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_383;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2148);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_61.length)
            {
               _loc2_ = var_61.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_719)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1067 = var_61.getValue(var_719);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_61.getValue(var_719);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1067.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1068.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1068.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_352.indexOf(_loc10_) >= 0 && var_500)
            {
               param1 = var_352.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_498[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_499[param1];
               }
               var_352.splice(param1,1);
               var_498.splice(param1,1);
               var_499.splice(param1,1);
               if(false)
               {
                  var_500 = false;
               }
