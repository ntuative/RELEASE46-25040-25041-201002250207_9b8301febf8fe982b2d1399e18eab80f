package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1111:int = 3;
      
      private const const_1626:int = 2;
      
      private var var_855:AvatarVisualizationData = null;
      ...
      {
         var_855 = param1 as AvatarVisualizationData;
         createSprites(const_1094);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_411.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_721);
         ...
         var _loc14_:Number = _loc8_ - var_1310;
         if(_loc14_ > 5000 && _loc6_ != null && _loc6_.getScale() == AvatarScaleType.const_50)
         {
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_324);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_282 != _loc3_.getUpdateID() || var_207 != param1.scale || var_160 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_497 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_497;
            ...
            if(var_566 != _loc7_)
            {
               for each(_loc49_ in var_411.getKeys())
               {
                  var_411.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_855.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_411.remove(_loc5_);
               var_411.add(_loc5_,_loc6_);
               var_566 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_308);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_256) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_256);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_523);
            _loc6_.appendAction(AvatarAction.const_512,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_465);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_50)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_366);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_295,AvatarAction.const_1247[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_792);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_946,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_987);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_991);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_829,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_623);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_634);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_841,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_820);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_992,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_356);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_381) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_725);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_482);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_894);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_597,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_857))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_855.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_282 = _loc3_.getUpdateID();
            var_160 = _loc4_.getUpdateID();
            var_207 = param1.scale;
            var_854.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_854)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_411 != null)
         {
            _loc1_ = var_411.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_411.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
