package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_484:String = "room";
      
      private static const const_742:int = -2;
      
      private static const const_485:String = "temporary_room";
      
      private static const const_274:String = "object_icon_sprite";
      
      private static const const_741:int = -3;
      
      private static const const_740:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1037:String = "tile_cursor";
      
      private static const const_275:int = -1;
      ...
      private var var_9:RoomContentLoader = null;
      
      private var var_284:Map = null;
      
      private var _connection:IConnection = null;
      
      private var _adManager:IAdManager = null;
      
      private var var_528:NumberBank;
      
      private var var_40:IRoomManager = null;
      ...
      private var var_622:RoomMessageHandler = null;
      
      private var var_621:IRoomRendererFactory = null;
      
      private var var_1620:Boolean = false;
      
      private var var_109:int = 0;
      
      private var var_939:Map;
      
      private var _communication:IHabboCommunicationManager = null;
      
      private var var_108:int = 0;
      
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_285 = new Map();
         var_528 = new NumberBank(1000);
         var_939 = new Map();
         var_284 = new Map();
         var_65 = new RoomObjectEventHandler(this);
         var_622 = new RoomMessageHandler(this);
         var_9 = new RoomContentLoader();
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_65 != null)
         {
            ...
            {
               return var_65.deleteWallItem(var_108,var_109,param1);
            }
         }
         return false;
      }
      ...
      private function getRoomCanvas(param1:int, param2:int, param3:int) : IRoomRenderingCanvas
      {
         ...
         var _loc5_:IRoomInstance = var_40.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_285.length; _loc2_++)
         {
            _loc3_ = var_285.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_610) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_714) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_626) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_638) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(param3 == RoomObjectCategoryEnum.const_28)
         {
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var_65.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_28)
            {
               return var_65.modifyWallItemData(var_108,var_109,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_25 != null)
         {
            var_25.release(new IIDRoomObjectFactory());
            var_25 = null;
         }
         if(var_401 != null)
         {
            var_401.release(new IIDRoomObjectVisualizationFactory());
            var_401 = null;
         }
         if(var_40 != null)
         {
            var_40.release(new IIDRoomManager());
            var_40 = null;
         }
         if(var_621 != null)
         {
            var_621.release(new IIDRoomRendererFactory());
            var_621 = null;
         }
         ...
         if(var_285 != null)
         {
            ...
            {
               _loc2_ = var_285.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = var_40.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_621.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_972;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            if(isPublicRoomWorldType(_loc12_))
            {
               if(var_9 != null)
               {
                  if(var_9.getPublicRoomWorldSize(_loc12_) != 64)
                  {
                     _loc10_.geometry.performZoomOut();
                  }
               }
            }
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_728);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_537);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_619);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_986);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_886);
      ...
      {
         var _loc4_:IRoomInstance = var_40.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_973) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_930);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_476,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_502,_loc5_);
                  }
               }
            }
         }
      ...
      private function getRoomObjectAdURL(param1:String) : String
      {
         if(var_9 != null)
         {
            return var_9.getRoomObjectAdURL(param1);
         }
         return "";
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_528,var_108,var_109,param2,param3));
            }
         }
      }
      ...
      public function loadRoomResources(param1:String) : Array
      {
         if(var_9 != null)
         {
            return var_9.loadLegacyContent(param1,_events);
         }
         return new Array();
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            return var_65.modifyRoomObject(var_108,var_109,param1,param2,param3);
         }
         return false;
      }
      ...
      public function get method_13() : IRoomManager
      {
         return var_40;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_284.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_284.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_662,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_620,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_514,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_40 = param2 as IRoomManager;
         if(var_40 != null)
         {
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_30);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_28);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_34);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_252);
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_62);
            var_40.setContentLoader(var_9);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_65 != null)
         {
            var_65.handleRoomObjectEvent(param1,var_108,var_109);
         }
      }
      ...
      private function getFurnitureType(param1:int) : String
      {
         if(var_9 != null)
         {
            return var_9.getActiveObjectType(param1);
         }
         return "";
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_195,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_317,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_297,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_936,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_954,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1000,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_245,param1,param2,param3,RoomObjectCategoryEnum.const_30));
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_639,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_25 == null || var_401 == null || var_40 == null || var_621 == null || _communication == null || var_97 == null || !var_1620)
         {
            return;
         }
         var_40.initialize(<nothing/>,this);
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_97 as Component).events.addEventListener(HabboConfigurationEvent.INIT,onHabboConfigurationInit);
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return getObject(getRoomIdentifier(param1,param2),const_275,RoomObjectCategoryEnum.const_62);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         if(isPublicRoomWorldType(_loc10_) && var_9 != null)
         {
            _loc12_ = var_9.getPublicRoomContentType(_loc10_) + "_";
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1339,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         if(var_40 != null)
         {
            var_40.update(param1);
         }
         updateRoomCameras(param1);
         var _loc2_:IRoomInstance = var_40.getRoom(getRoomIdentifier(var_108,var_109));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_741,RoomObjectCategoryEnum.const_252);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1127);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_274);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1127);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_274);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_401 = param2 as IRoomObjectVisualizationFactory;
         if(var_9 != null)
         {
            var_9.visualizationFactory = var_401;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_25 != null)
         {
            if(false)
            {
               var_25.events.addEventListener(RoomObjectMouseEvent.const_210,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_358,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_461,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_229,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_547,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_103,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_117,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_STICKIE,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_PRESENT,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_126,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_121,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_92,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_400,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_422,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_362,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_399,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_405,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_439,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_431,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_409,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_432,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.DIMMER_STATE,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_369,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_441,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_230,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_354,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_286,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_281,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_371,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_995,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_420,roomObjectEventHandler);
               var_25.events.addEventListener(AvatarWalkWarpingWarningEvent.const_387,warningEventHandler);
            }
         }
      }
      ...
      private function getWallItemColorIndex(param1:int) : int
      {
         if(var_9 != null)
         {
            return var_9.getWallItemColorIndex(param1);
         }
         return 0;
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         if(var_9 != null)
         {
            return var_9.getObjectCategory(param1);
         }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_108,var_109);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_651) != 0)
         {
            return false;
         }
         if(var_65 != null)
         {
            return var_65.initializeRoomObjectInsert(var_108,var_109,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            _loc2_ = 0;
            while(_loc2_ < var_284.length)
            {
               _loc3_ = var_284.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_245,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      {
         return var_40.isContentAvailable(param1);
      }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_30);
      }
      
      public function insertContentLibrary(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         return var_9.insertObjectContent(param1,param2,param3);
      }
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = var_40.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_28:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_195));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_483);
                     break;
                  case RoomObjectCategoryEnum.const_34:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_164);
               }
            }
         }
      ...
      private function getWallItemType(param1:int, param2:String = null) : String
      {
         if(var_9 != null)
         {
            return var_9.getWallItemType(param1,param2);
         }
         return "";
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_308);
         }
      ...
      {
         disposeObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_30);
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_590)
         {
            var_1620 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_195,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_317,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_297,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_972,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_245,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      {
         var _loc5_:IRoomInstance = var_40.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_429,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_740) as Sprite;
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(var_65 != null)
         {
            var_65.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      private function getFurnitureColorIndex(param1:int) : int
      {
         if(var_9 != null)
         {
            return var_9.getActiveObjectColorIndex(param1);
         }
         return 0;
      }
      ...
      public function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(var_9 != null)
         {
            _loc7_ = var_9.getActiveObjectType(param1);
            _loc8_ = String(var_9.getActiveObjectColorIndex(param1));
         }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_65 != null)
         {
            return var_65.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var_40.disposeRoom(_loc3_);
         var _loc4_:RoomInstanceData = var_285.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_588,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_621 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getRoomObjectWithIndex(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc6_:IRoomInstance = var_40.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_437 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_40.getRoom(const_485);
         if(_loc10_ == null)
         {
            _loc10_ = var_40.createRoom(const_485,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_528.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_30:
            case RoomObjectCategoryEnum.const_28:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_195,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_483,param8);
               break;
            case RoomObjectCategoryEnum.const_34:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_164,param2);
               break;
            case RoomObjectCategoryEnum.const_62:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_139,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_146,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_146,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_633,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_733,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_645,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_476,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_939.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_906,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_528.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      public function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(var_9 != null)
         {
            _loc7_ = var_9.getWallItemType(param1,param5);
            _loc8_ = String(var_9.getWallItemColorIndex(param1));
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_742,RoomObjectCategoryEnum.const_252);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,param1);
         if(_loc9_ != null)
         {
            var_1127 = param1;
            var_1383 = param2;
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_274);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1383 - _loc12_.width / 2;
               _loc11_.y = var_1384 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_454,var_108,var_109,-1,RoomObjectCategoryEnum.const_217));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_275,const_484);
                  var_65.handleRoomObjectEvent(_loc14_,var_108,var_109);
               }
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_9 != null)
         {
            var_9.setRoomObjectAlias(param1,param2);
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_108,var_109,param1,param2,new Vector3d(),1,null);
         }
         else if(var_9 != null)
         {
            _loc8_ = null;
            _loc9_ = 0;
            if(param2 == RoomObjectCategoryEnum.const_30)
            {
               _loc8_ = var_9.getActiveObjectType(param1);
               _loc9_ = var_9.getActiveObjectColorIndex(param1);
            }
            else if(param2 == RoomObjectCategoryEnum.const_28)
            {
               _loc8_ = var_9.getWallItemType(param1,param4);
               _loc9_ = var_9.getWallItemColorIndex(param1);
            }
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1127);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_274);
            _loc11_ = addOverlayIconSprite(_loc10_,const_274,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1383 - _loc6_.data.width / 2;
               _loc11_.y = var_1384 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_293,param1.image,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_822,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_880,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_985,RoomObjectVariableEnum.const_293,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_285.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_285.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function isPublicRoomWorldType(param1:String) : Boolean
      {
         if(var_9 != null)
         {
            return var_9.isPublicRoomWorldType(param1);
         }
         return false;
      }
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_25 = param2 as IRoomObjectFactory;
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_9 != null)
         {
            _events.addEventListener(RoomContentLoader.const_590,onContentLoaderReady);
            var_9.initialize(_events,var_97);
         }
         initializeRoomManager();
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_65 != null)
         {
            var_65.cancelRoomObjectInsert(var_108,var_109);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_40.getRoom(const_485);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         var _loc4_:* = null;
         var _loc5_:* = 0;
         var _loc6_:int = var_9.getObjectCategory(param1);
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_906);
               ...
               var_528.freeNumber(_loc10_ - 1);
               _loc13_ = var_939.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_108,var_109,const_275,RoomObjectCategoryEnum.const_62,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = var_40.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         var _loc8_:int = _loc8_ = RoomObjectCategoryEnum.const_62;
         var _loc9_:* = null;
         var _loc10_:* = 1;
         if(isPublicRoomWorldType(param6))
         {
            _loc12_ = var_9.getPublicRoomContentType(param6);
            _loc9_ = _loc7_.createRoomObject(const_275,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1015,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_651,1,true);
            _loc13_ = parseInt(var_97.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_919,_loc13_,true);
            if(var_9 != null)
            {
               _loc10_ = Number(var_9.getPublicRoomWorldHeightScale(param6));
            }
         }
         else
         {
            _loc9_ = _loc7_.createRoomObject(const_275,const_484,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_651,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_728,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_610,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_626,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_714,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_638,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_933,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_662,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_620,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_514,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_476,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_204);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_537,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_619,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_537,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_619,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_986,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_886,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_742,const_1037,RoomObjectCategoryEnum.const_252);
         _loc7_.createRoomObject(const_741,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_252);
         return _loc7_;
      }
