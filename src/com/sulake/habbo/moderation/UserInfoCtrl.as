package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_743:int = 31536000;
      
      private static const const_746:int = 86400;
      
      private static const const_744:int = 3600;
      
      private static const const_745:int = 60;
      ...
      {
         if(param1 < 2 * const_745)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_744)
         {
            return Math.round(param1 / const_745) + " mins ago";
         }
         if(param1 < 2 * const_746)
         {
            return Math.round(param1 / const_744) + " hours ago";
         }
         if(param1 < 2 * const_743)
         {
            return Math.round(param1 / const_746) + " days ago";
         }
         return Math.round(param1 / const_743) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_49,WindowTracker.const_825,_data.userId),_callerFrame,var_953,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_754.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_49.getXmlWindow("user_info"));
            var_754.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new ModActionCtrl(var_49,_data.userId,_data.userName,var_1326),_callerFrame,var_953,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new RoomVisitsCtrl(var_49,_data.userId),_callerFrame,var_953,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new SendMsgsCtrl(var_49,_data.userId,_data.userName,var_1326),_callerFrame,var_953,false,true);
      }
