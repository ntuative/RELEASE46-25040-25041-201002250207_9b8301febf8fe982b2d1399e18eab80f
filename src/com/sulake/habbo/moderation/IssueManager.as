package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_891:String = "issue_bundle_open";
      
      public static const const_712:String = "issue_bundle_my";
      
      public static const const_794:String = "issue_bundle_picked";
      ...
      private var var_574:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_132 = new Map();
         var_851 = new Map();
         var_574 = new IssueBrowser(this,var_56.windowManager,var_56.assets);
         var_697 = [];
         var_852 = [];
         var_1049 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1049.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_132)
         {
            switch(param1)
            {
               case const_891:
                  ...
                  break;
               case const_712:
                  if(_loc4_.state == IssueMessageData.const_350 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      {
         var _loc2_:IssueBundle = var_132.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_697 = var_697.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_851.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_132.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_132.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_851.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1161)
         {
            var_155.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_132)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_851.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_851.add(param1.issueId,_loc2_);
            var_132.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_697.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_143)
         {
            _loc5_ = getBundles(const_712);
            _loc6_ = false;
            ...
            _loc8_ = var_852.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1049.remove(param1);
         var_1049.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_350 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_852 = var_852.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_132.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_1049.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_132.getValues();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_574 == null || !var_574.isOpen())
         {
            var_56.soundManager.playSound(HabboSoundTypesEnum.const_876);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_851.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_132.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_132.getValues();
         var _loc4_:int = var_56.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_350 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
