package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2377:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_47 = param3;
         var_1123 = param4;
         var_1578 = var_574.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1578 == null)
            {
               return;
            }
            _loc2_ = var_1578.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = var_47.width;
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_574.assets.getAssetByName(_loc8_) as BitmapDataAsset;
