package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1269:int = 6;
      
      public static const const_643:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1228:int = 7;
      
      public static const const_797:int = 3;
      
      public static const const_1278:int = 8;
      
      public static const const_825:int = 5;
      
      public static const const_1350:int = 1;
      
      public static const const_1222:int = 2;
       
      
      private var var_1543:Dictionary;
      
      public function WindowTracker()
      {
         var_1543 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1543[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1543[param1] = _loc2_;
         }
         return _loc2_;
      }
