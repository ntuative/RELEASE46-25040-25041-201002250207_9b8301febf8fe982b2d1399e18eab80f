package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1283 ? 0 : 1,_roomId),var_49,WindowTracker.const_643,_roomId),var_52,false,false,true);
      }
