package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         var _loc4_:* = var_47.scrollableRegion.height > var_47.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2204.clone());
      ...
      {
         var_2204 = IWindowContainer(var_49.getXmlWindow("roomvisits_row"));
         ...
         var_47 = IItemListWindow(var_52.findChildByName("visits_list"));
