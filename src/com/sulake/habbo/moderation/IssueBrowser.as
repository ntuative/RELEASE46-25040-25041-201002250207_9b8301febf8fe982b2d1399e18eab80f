package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1513:IIssueBrowserView;
      
      private const const_1623:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1625:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1514:IIssueBrowserView;
      
      private const const_1633:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1624:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_228:ITabContextWindow;
      
      private var var_1512:PickedIssuesView;
      
      private var var_338:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_228 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_228.numTabItems)
            {
               _loc5_ = var_228.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_228.selector.getSelectableByName("open_issues");
         var_228.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_338.view.width = var_228.container.width;
         var_338.view.height = var_228.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1624:
               if(var_1514 == null)
               {
                  var_1514 = new MyIssuesView(issueManager,this,var_228.container);
               }
               return var_1514;
            case const_1623:
               if(var_1513 == null)
               {
                  var_1513 = new OpenIssuesView(issueManager,this,var_228.container);
               }
               return var_1513;
            case const_1625:
               if(var_1512 == null)
               {
                  var_1512 = new PickedIssuesView(issueManager,this,var_228.container);
               }
               return var_1512;
            default:
               return null;
