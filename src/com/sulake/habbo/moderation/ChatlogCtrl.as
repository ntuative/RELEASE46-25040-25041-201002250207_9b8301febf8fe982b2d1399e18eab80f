package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1526:IMessageComposer;
      ...
      private var var_789:IWindowContainer;
      ...
      {
         var_789 = IWindowContainer(var_49.getXmlWindow("chatlog_roomheader"));
         var_790 = IWindowContainer(var_49.getXmlWindow("chatlog_chatline"));
         ...
         var_47 = IItemListWindow(var_52.findChildByName("chatline_list"));
         var_52.procedure = onWindow;
         var _loc1_:IWindow = var_52.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_49.connection.send(var_1526);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_789.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_790.clone());
         _loc4_.color = var_1170[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
