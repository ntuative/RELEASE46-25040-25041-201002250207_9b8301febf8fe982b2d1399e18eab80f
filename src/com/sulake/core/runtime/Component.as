package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1562:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_978:uint = 4;
      ...
      protected var var_405:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_1873:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_931 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_931);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1099 & const_978)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_405 + "]";
      }
   }
}
