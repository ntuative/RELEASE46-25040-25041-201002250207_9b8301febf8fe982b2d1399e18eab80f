package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_1112:uint = 1;
      
      private static const const_494:uint = 0;
      
      private static const const_775:uint = 2;
       
      
      private var var_1320:Error;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_775)
            {
               Core.crash("Error catched in EventDispatcher; some event listener crashed!",var_1320.errorID,var_1320);
            }
            return _result == const_494;
         }
         return false;
      }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         var array:Array = var_273[event.type];
         if(array)
         {
            callbacks = [];
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1112) : uint(const_494);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_273)
            {
               _loc2_ = var_273[_loc1_] as Array;
               for each(_loc3_ in _loc2_)
               {
                  _loc3_.callback = null;
               }
               delete var_273[_loc1_];
            }
            var_273 = null;
