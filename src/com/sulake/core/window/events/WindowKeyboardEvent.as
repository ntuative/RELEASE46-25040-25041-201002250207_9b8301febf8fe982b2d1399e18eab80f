package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_140:String = "WKE_KEY_DOWN";
      
      public static const const_500:String = "WKE_KEY_UP";
      ...
      {
         _type = param1;
         var_708 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get keyLocation() : uint
      {
         return var_708.keyLocation;
      }
      
      public function get shiftKey() : Boolean
      {
         return var_708.shiftKey;
      }
      
      public function get charCode() : uint
      {
         return var_708.charCode;
      }
      
      public function get keyCode() : uint
      {
         return var_708.keyCode;
      }
      
      public function get altKey() : Boolean
      {
         return var_708.altKey;
      }
      ...
      {
         return new WindowKeyboardEvent(_type,var_708,window,related,bubbles,cancelable);
      }
   }
}
