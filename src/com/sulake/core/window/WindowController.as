package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1476:Point = new Point();
      ...
      protected var var_613:Function;
      
      protected var _children:Array;
      
      protected var _debug:Boolean = false;
      
      private var var_1894:uint;
      
      protected var var_6:WindowController;
      
      protected var var_743:uint = 10;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_14)
         {
            var_14 = getGraphicContext(!testParamFlag(WindowParam.const_29));
         }
         ...
         if(_loc12_ != null)
         {
            var_364 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_54 = var_364.clone();
            var_5 = var_364.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_112,WindowParam.const_132);
         var _loc2_:* = !testParamFlag(WindowParam.const_123,WindowParam.const_142);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_16 & 0);
               if(_loc5_ == WindowParam.const_250)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_284)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_746 = param1;
         var_615 = !!var_746 ? uint(var_615 | var_1373) : uint(var_615 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1894 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_952:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1370:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1376:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_437:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_279:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_14)
         {
            var_14 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_509,var_5);
            var_14.visible = var_332;
         }
         return var_14;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_967;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_393 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_5,WindowRedrawFlag.const_966);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1016 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_279,this,param1));
         return param1;
      }
      ...
      {
         return !testParamFlag(WindowParam.const_29) || var_14 != null;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_743);
      }
      
      public function set color(param1:uint) : void
      {
         var_1373 = param1 & 4278190080;
         var_615 = !!var_746 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_5,WindowRedrawFlag.const_70);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_671))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_902;
                  if(testParamFlag(WindowParam.const_319))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_194))
                        {
                  ...
                  if((var_16 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        ...
                        {
                           _context.getWindowServices().getMouseScalingService().begin(_loc5_,var_16 & 0);
                           break;
                        }
                        _loc5_ = _loc5_.parent;
                     }
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_194))
                  {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_193:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_132))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_168,WindowParam.const_142))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                     {
                        _loc8_ = uint(var_16);
                        var_16 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_417))
                        {
                           var_6.width += 0 - 0;
                        }
                        ...
                        var_16 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_251,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_411:
                  _context.invalidate(this,var_5.union(var_54),WindowRedrawFlag.const_377);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_801,this,null));
                     if(var_6 != null)
                     {
               ...
               case WindowNotifyEvent.const_298:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_699,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_206,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_391:
                  _context.invalidate(this,var_5,WindowRedrawFlag.const_889);
                  break;
               case WindowNotifyEvent.const_412:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_425:
                  if(!(var_16 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_377);
                     }
                  }
                  else if(var_16 & 0)
                  {
               ...
               case WindowNotifyEvent.const_206:
                  ...
                  break;
               case WindowNotifyEvent.const_452:
                  var_6.getRegionProperties(null,var_296);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_279:
      ...
      {
         return var_613 != null ? var_613 : (var_6 != null ? var_6.procedure : nullEventProc);
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_861,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_743);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_298;
         update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_540;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1016 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            _loc7_ = uint(var_16 & 0);
            if(_loc7_ == WindowParam.const_359)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_404)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_363)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_990,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_554,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_193,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1245,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_58,true);
         _loc1_.type = WindowNotifyEvent.const_1332;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_159 && var_743 > 0)
         {
            if(!testParamFlag(WindowParam.const_29))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1476,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1476,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1260,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_58,false);
         _loc1_.type = WindowNotifyEvent.const_1354;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_296 = var_6.rectangle.clone();
               var_54.x = var_5.x;
               var_54.y = var_5.y;
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_437,this,var_6));
            }
            else
            {
               var_296.x = 0;
               ...
               var_296.width = 0;
               var_296.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_904,this,_loc2_));
            }
         }
      }
      ...
      {
         var _loc3_:uint = var_16;
         var _loc4_:*;
         var_16 = !!param2 ? (_loc4_ = var_16 | param1, var_16 |= param1, uint(_loc4_)) : (_loc4_ = var_16 & ~param1, var_16 &= ~param1, uint(_loc4_));
         if(var_16 != _loc3_)
         {
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_16,_context,var_5,null,var_613,properties,var_616.concat(),_id) as WindowController;
         _loc2_.var_743 = var_743;
         _loc2_.var_159 = var_159;
         _loc2_._debug = _debug;
         _loc2_.var_296 = var_296.clone();
         _loc2_.var_5 = var_5.clone();
         _loc2_.var_364 = var_364.clone();
         ...
         _loc2_.var_615 = var_615;
         _loc2_.var_1373 = var_1373;
         _loc2_.var_1103 = var_1103;
         _loc2_.var_332 = var_332;
         _loc2_.var_393 = var_393;
         _loc2_.var_16 = var_16;
         _loc2_.var_33 = var_33;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_316;
         _loc2_.background = var_746;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_532;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_743 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1001,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         if(var_33 == WindowState.const_442)
         {
            return true;
         }
         var_33 = WindowState.const_442;
