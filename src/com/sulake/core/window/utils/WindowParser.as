package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1442:String = "_INCLUDE";
      
      public static const const_893:String = "_EXCLUDE";
      
      public static const const_1487:String = "_TEMP";
      
      private static const const_1053:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1054:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1097:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_923:Dictionary;
      
      protected var var_1363:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1362:Dictionary;
      
      protected var var_1098:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         _context = param1;
         var_1098 = new Dictionary();
         var_1097 = new Dictionary();
         TypeCodeTable.fillTables(var_1098,var_1097);
         var_923 = new Dictionary();
         var_1362 = new Dictionary();
         ParamCodeTable.fillTables(var_923,var_1362);
         var_1363 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1054,"");
         return param1.replace(const_1053,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1098)
            {
               delete var_1098[_loc1_];
            }
            for(_loc1_ in var_1097)
            {
               delete var_1097[_loc1_];
            }
            for(_loc1_ in var_923)
            {
               delete var_923[_loc1_];
            }
            for(_loc1_ in var_1362)
            {
               delete var_1362[_loc1_];
            }
            var_1363.dispose();
            var_1363 = null;
            _context = null;
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_168)
                     {
                        window.y = rect.y;
                     }
                  }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_893) == -1)
                  {
