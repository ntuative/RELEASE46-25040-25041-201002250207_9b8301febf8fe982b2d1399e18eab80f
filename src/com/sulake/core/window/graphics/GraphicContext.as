package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_948:uint = 256;
      
      protected static var var_619:uint = 0;
      
      protected static var var_366:uint = 0;
      
      public static const const_862:uint = 2;
      
      public static const const_1583:uint = 128;
      
      public static const const_1504:uint = 64;
      
      public static const const_635:uint = 4;
      
      public static const const_1143:uint = 0;
      
      public static const const_1360:uint = 16;
      ...
      protected var var_1590:Boolean;
      
      protected var var_161:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1225:
               ...
               break;
            case GraphicContext.const_1360:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_635:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_948:
               break;
            case GraphicContext.const_1143:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_614)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_366 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_161 = new Sprite();
            var_161.name = this.name + " - Child Container";
            var_161.mouseEnabled = false;
            addChild(var_161);
         }
         return var_161;
      }
         ...
         if(var_614)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_366 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1590,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1590,16777215);
                  }
                  var_366 += bitmap.width * bitmap.height * 4;
               }
