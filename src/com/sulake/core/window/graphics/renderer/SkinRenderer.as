package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_430:Dictionary;
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_314)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_314[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_313[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_430[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_313[param2];
         if(_loc3_ == null)
         {
            throw new Error("Template \"" + param2 + "\" not found in renderer!");
         }
         var_314[param1] = _loc3_;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_430[_loc1_]).dispose();
            delete var_430[_loc1_];
         }
         var_430 = null;
         _layoutsByState = null;
         for(_loc1_ in var_313)
         {
            ISkinTemplate(var_313[_loc1_]).dispose();
            delete var_313[_loc1_];
         }
         var_313 = null;
         var_314 = null;
      }
