package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2331:Rectangle = new Rectangle();
       
      
      protected var var_205:Boolean;
      
      protected var var_67:TextMargins;
      
      protected var var_522:String = "none";
      
      protected var var_612:Number;
      
      protected var var_360:Number;
      
      protected var _field:TextField;
      
      protected var var_741:Boolean = false;
      ...
      {
         var_67 = new TextMargins(0,0,0,0,setTextMargins);
         var_205 = false;
         var_612 = 0;
         var_360 = 0;
         if(_field == null)
      ...
      {
         param1.var_67.dispose();
         param1.var_67 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_612 * maxScrollH,var_360 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_741)
         {
            context.removeLocalizationListener(var_316,this);
         }
         if(var_67 != null)
         {
            var_67.dispose();
      ...
      {
         var_612 = param1;
         _field.scrollH = var_612 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_316 = param1;
         if(var_316.charAt(0) == "$" && var_316.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_316.slice(2,var_316.indexOf("}")),this);
            var_741 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_205)
         {
            if(param2.type == WindowNotifyEvent.const_193)
            {
               refreshTextImage();
            }
         }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_67.dispose();
            var_67 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_786,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_458,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_458,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_59,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_734,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_734,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("margin_left",var_67.left,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_top",var_67.top,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_right",var_67.right,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_67.bottom,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("auto_size",var_522,PropertyStruct.STRING,var_522 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_734,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_612 = var_612;
         _loc1_.var_360 = var_360;
         _loc1_.var_67 = var_67.clone(_loc1_.setTextMargins);
         _loc1_.var_522 = var_522;
         _loc1_.var_741 = var_741;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_522 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_522 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_522 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_522 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
