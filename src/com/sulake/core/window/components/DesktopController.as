package com.sulake.core.window.components
{
   ...
   public class DesktopController extends ActivatorController implements IDesktopWindow, IDisplayObjectWrapper
   {
      ...
      {
         var_613 = param1 != null ? param1 : defaultProcedure;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_14)
         {
            var_14 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_948,var_5);
            GraphicContext(var_14).mouseEnabled = true;
            GraphicContext(var_14).doubleClickEnabled = true;
         }
         return var_14;
      }
