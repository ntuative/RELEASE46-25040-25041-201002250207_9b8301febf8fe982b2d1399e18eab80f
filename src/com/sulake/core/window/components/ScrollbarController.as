package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1064:String = "increment";
      
      private static const const_490:String = "slider_bar";
      
      private static const const_1065:String = "decrement";
      
      private static const const_756:String = "slider_track";
      ...
      protected var var_742:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_159 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_423;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_490:
               if(param2.type == WindowNotifyEvent.const_240)
               {
                  if(!var_555)
                  {
                     if(_horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_437)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_756) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_21 != null && true)
         {
            IWindow(var_21).removeEventListener(WindowEvent.const_42,onScrollableResized);
         }
         var_21 = param1;
         if(var_21 != null && true)
         {
            IWindow(var_21).addEventListener(WindowEvent.const_42,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_490) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_803 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_803 != null)
         {
            _loc1_ = findParentByName(var_803) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_803) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
         ...
         if(var_6 is IScrollableWindow)
         {
            scrollable = IScrollableWindow(var_6);
            return true;
         }
         if(var_6 is IWindowContainer && !(var_6 is IDesktopWindow))
         {
            _loc2_ = uint(IWindowContainer(var_6).numChildren);
            _loc4_ = 0;
            while(_loc4_ < _loc2_)
            {
               _loc3_ = IWindowContainer(var_6).getChildAt(_loc4_) as IScrollableWindow;
               if(_loc3_)
               {
                  scrollable = _loc3_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1064)
            {
               if(var_21)
               {
                  var_555 = true;
            ...
            else if(param2.name == ScrollbarController.const_1065)
            {
               if(var_21)
               {
                  var_555 = true;
            ...
            else if(param2.name == ScrollbarController.const_756)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_490).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_867)
         {
