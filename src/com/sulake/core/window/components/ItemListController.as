package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1021:String = "resize_on_item_update";
      
      protected static const const_1024:String = "spacing";
      
      protected static const const_1385:Boolean = false;
      ...
      protected var var_744:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_89 = 0;
         var_68 = 0;
         _horizontal = param2 == WindowType.const_310;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_159 = var_746 || !testParamFlag(WindowParam.const_29);
         _container = _context.create("_CONTAINER","",WindowType.const_335,WindowStyle.const_306,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_42,containerEventHandler);
         _container.addEventListener(WindowEvent.const_384,containerEventHandler);
         _container.addEventListener(WindowEvent.const_291,containerEventHandler);
         _container.addEventListener(WindowEvent.const_401,containerEventHandler);
         resizeOnItemUpdate = var_1100;
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_384,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_291,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_401,containerEventHandler);
         super.dispose();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1024,_spacing,PropertyStruct.const_59,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1023,var_744,PropertyStruct.const_57,var_744 != const_1386));
         _loc1_.push(new PropertyStruct(const_1022,var_524,PropertyStruct.const_57,var_524 != const_1385));
         _loc1_.push(new PropertyStruct(const_1021,var_1100,PropertyStruct.const_57,var_1100 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1021:
                  ...
                  break;
               case const_1023:
                  var_744 = _loc2_.value as Boolean;
                  break;
            }
         }
