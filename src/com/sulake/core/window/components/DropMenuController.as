package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_336:String = "_DROPMENU_TITLETEXT";
       
      
      private var var_121:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_121 == null || false)
         {
            var_121 = context.create(name + "::submenu","",WindowType.const_415,var_81,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_121.setGlobalRectangle(_loc1_);
         }
         var_121.activate();
         return var_121;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_828)
         {
            if(param2 == var_121)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_436,var_81,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_335,var_81,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_454 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_454).setStateFlag(WindowState.const_44,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_538)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_453,getSubMenu(),subMenuEventProc);
                  var_538 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_367,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_454 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_329,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_121 != null)
            {
               _loc2_ = var_121.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      {
         return getChildByName(DropMenuController.const_336) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_538 = false;
            getTitleText().text = var_454 < var_453.length && var_454 > -1 ? "null" : caption;
         }
      }
   }
}
