package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_765:String = "margin_top";
      
      private static const const_1088:String = "_HEADER";
      
      private static const const_768:String = "margin_right";
      
      private static const const_1089:String = "_SCALER";
      
      private static const TITLE_ELEMENT_TAG:String = "_TITLE";
      
      private static const const_1090:String = "_CONTENT";
      
      private static const const_766:String = "margin_left";
      
      private static const const_767:String = "margin_bottom";
      ...
      private var var_1256:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_766,_loc3_.left,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_765,_loc3_.top,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_768,0 - _loc3_.right,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_767,0 - _loc3_.bottom,PropertyStruct.const_59,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_226);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_208);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_226,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_226,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_208,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_208,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1256 == null)
         {
            var_1256 = findChildByTag(const_1088) as IHeaderWindow;
            if(!var_1256)
            {
      ...
      {
         return findChildByTag(const_1089) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_238,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1090) as IWindowContainer;
            if(!var_20)
            {
