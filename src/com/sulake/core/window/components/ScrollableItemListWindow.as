package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_904:IItemListWindow;
      
      private var var_355:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_355)
         {
            var_355 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_355)
            {
               var_355.addEventListener(WindowEvent.const_259,scrollBarEventProc);
               var_355.addEventListener(WindowEvent.const_186,scrollBarEventProc);
            }
         }
         return var_355;
      }
      ...
      override public function dispose() : void
      {
         if(var_355)
         {
            var_355.removeEventListener(WindowEvent.const_259,scrollBarEventProc);
            var_355.removeEventListener(WindowEvent.const_186,scrollBarEventProc);
            var_355 = null;
         }
         if(var_904)
         {
      ...
      {
         if(param1.type == WindowEvent.const_259)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_186)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_904)
         {
            var_904 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_904;
      }
