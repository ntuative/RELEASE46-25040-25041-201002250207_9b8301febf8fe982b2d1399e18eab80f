package com.sulake.core.window.components
{
   ...
   public class TabSelectorController extends SelectorController implements ITabSelectorWindow
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_279)
         {
            updateSelectableRegion();
         }
         else if(param2.type == WindowNotifyEvent.const_251)
         {
            updateSelectableRegion();
         }
         else if(param2.type == WindowNotifyEvent.const_240)
         {
            updateSelectableRegion();
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("spacing",_spacing,PropertyStruct.const_59,_spacing != 0));
         return _loc1_;
      }
