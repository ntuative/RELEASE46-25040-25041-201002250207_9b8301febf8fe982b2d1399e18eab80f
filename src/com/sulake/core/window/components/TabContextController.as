package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_930:ITabSelectorWindow;
      
      private var var_879:Boolean = false;
      
      protected var var_1587:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1587 == null)
         {
            var_1587 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1587;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_930 == null)
         {
            var_930 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_930 != null)
            {
               var_930.procedure = selectorEventProc;
            }
         }
         return var_930;
      }
      ...
      {
         return !!var_879 ? selector.iterator : null;
      }
