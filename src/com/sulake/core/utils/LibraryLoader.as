package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected var var_1372:Boolean = false;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_321 = this.getDefinition(_name) as Class;
         if(var_321 == null)
         {
         ...
         try
         {
            xmlClass = var_321.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_439 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_363 + " for file \"" + var_15.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_929 > 0)
            {
               var_15.close();
               var_15.unload();
               addRequestCounterToUrlRequest(var_315,const_1387 - var_929);
               var_15.load(var_315,_context);
               --var_929;
               return true;
            }
