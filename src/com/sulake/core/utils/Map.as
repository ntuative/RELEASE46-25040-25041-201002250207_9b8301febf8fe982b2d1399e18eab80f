package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      public function remove(param1:*) : *
      {
         ...
         var _loc3_:int = var_27.indexOf(_loc2_);
         if(_loc3_ >= 0)
         {
            var_27.splice(_loc3_,1);
      ...
      public function unshift(param1:*, param2:*) : Boolean
      {
         ...
         var_27.unshift(param2);
         var_231.unshift(param1);
         ++_length;
         return true;
      }
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         var_133[param1] = param2;
         var _loc3_:int = var_231.indexOf(param1);
         if(_loc3_ == -1)
         {
            var_27[_length] = param2;
            var_231[_length] = param1;
            ++_length;
         }
         else
         {
            var_27.splice(_loc3_,1,param2);
         }
      }
