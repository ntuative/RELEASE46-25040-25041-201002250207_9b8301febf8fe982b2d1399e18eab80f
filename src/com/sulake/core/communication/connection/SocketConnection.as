package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1316:int = 10000;
      ...
      private var var_715:IEncryption;
      
      private var var_714:int;
      
      private var var_349:ByteArray;
      ...
      private var var_350:IConnectionStateListener;
      
      private var var_585:IProtocol;
      
      private var var_884:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_300 = param2;
         var_349 = new ByteArray();
         var_884 = new MessageClassManager();
         var_79 = new Socket();
         var_348 = new Timer(const_1316,1);
      ...
      {
         var_348.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_714));
      ...
      {
         var_348.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_714));
      ...
      {
         var_348.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_714));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_884.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         ...
         if(var_350)
         {
            var_350.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_715 != null)
         {
            _loc3_ = var_715.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_350)
         {
            var_350.connectionInit(param1,param2);
         }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_349.writeByte(var_79.readUnsignedByte());
         }
      }
      ...
      {
         var_884.registerMessages(param1);
      }
      ...
      {
         var_348.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_714));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_585.getMessages(var_349,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_350)
            {
               var_350.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_884.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_349,_loc2_);
            var_349 = _loc18_;
         }
      }
      ...
      {
         var_348.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_714));
         switch(param1.type)
         {
      ...
      {
         var_348.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_714));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_715 + "\n");
      }
   }
}
