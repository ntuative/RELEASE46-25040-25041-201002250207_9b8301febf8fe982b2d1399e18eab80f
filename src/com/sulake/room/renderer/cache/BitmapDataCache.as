   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               var_516 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         var_516 += param2.width * param2.height * 4;
      }
      ...
      public function compress() : void
      {
         ...
         {
            var_356.sortOn("useCount",0 | 0);
            _loc2_ = -1;
            while(_loc2_ >= 0)
            {
               _loc1_ = var_356[_loc2_] as BitmapDataCacheItem;
            ...
            var_356.splice(_loc2_,0 - _loc2_);
            if(memUsage > memLimit)
            {
               var_356.sortOn("memUsage",Array.NUMERIC);
               while(memUsage > memLimit)
               {
                  _loc1_ = var_356.pop() as BitmapDataCacheItem;
                  if(_loc1_ == null)
                  {
                     break;
                  }
