package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_111:IRoomManagerListener;
      ...
      private var var_473:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_472 = [];
         var_471 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_280,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_380,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_663,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_33 == const_1195)
         {
            if(var_827 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_401.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_401.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_473.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_473 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_473 != null)
         {
            return var_473.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_111 != null)
            {
               var_111.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(var_111 != null)
            {
               var_111.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(var_111 != null)
         {
            var_111.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_43.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_472.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_472.splice(_loc2_,1);
            }
            if(false)
            {
               ...
               if(var_111 != null)
               {
                  var_111.roomManagerInitialized();
               }
            }
         }
         else
         {
            var_33 = const_510;
            var_111.roomManagerInitialized(false);
         }
      }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_401.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_401.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_473.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(var_111 != null)
                                 {
                                    var_111.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
