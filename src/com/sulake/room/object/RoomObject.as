package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      {
         var_1415.assign(var_223);
         return var_1415;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_458.length)
         {
            if(var_458[param2] != param1)
            {
               var_458[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      {
         if(param1 >= 0 && param1 < var_458.length)
         {
            return var_458[param1];
         }
         return -1;
      }
