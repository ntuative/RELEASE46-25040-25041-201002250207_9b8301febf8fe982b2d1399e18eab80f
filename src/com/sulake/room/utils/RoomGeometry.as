package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_701:Number = 64;
      
      public static const const_965:Number = 32;
      ...
      private var var_1469:Number = 1;
      
      private var var_2333:Number = 500;
      
      private var var_1467:Number = 1;
      
      private var var_85:Vector3d;
      
      private var var_84:Vector3d;
      
      private var var_2334:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_84 = new Vector3d();
         var_1012 = new Vector3d();
         var_1468 = 1;
         var_1467 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1469 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_397 != param1 * var_1469)
         {
            var_397 = param1 * var_1469;
            ++var_78;
         }
      }
      ...
      {
         if(var_396 != param1 * var_1468)
         {
            var_396 = param1 * var_1468;
            ++var_78;
         }
      }
      ...
      {
         if(var_399 != param1 * var_1467)
         {
            var_399 = param1 * var_1467;
            ++var_78;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_398 != null)
         {
            ...
            var_398.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_398.add(_loc3_,_loc4_);
            ++var_78;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1012.assign(_loc22_);
         }
         else
         {
            var_1012.assign(_loc17_);
         }
         ++var_78;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_399;
         _loc2_.z *= var_397;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1012);
         if(_loc3_ < var_2334 || _loc3_ > var_2333)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_399;
            _loc2_.z *= var_397;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1012);
         }
      ...
      {
         return new Vector3d(0 * var_396,0 * var_399,0 * var_397);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_398 != null)
         {
            ...
            return var_398.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_396,0 * var_399,0 * var_397);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_396,param2.y * var_399,param2.z * var_397);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_396,param3.y * var_399,param3.z * var_397);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_396,param4.y * var_399,param4.z * var_397);
