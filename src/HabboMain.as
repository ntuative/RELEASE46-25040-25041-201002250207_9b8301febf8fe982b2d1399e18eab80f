package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            var_31.error("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",true,Core.const_974);
      ...
      private function prepareCore() : void
      {
         ...
         _loc1_.addEventListener(AssetLoaderEvent.const_43,configLoadedHandler);
      }
      ...
      private function initializeCore() : void
      {
         ...
         {
            trackLoginStep(Habbo.const_24);
            Core.crash("Failed to initialize the core: " + error.message,Core.const_958,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            trackLoginStep(Habbo.const_24);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_958,error);
            Core.dispose();
         }
      }
