package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_461 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         return !true ? var_124[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_719))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_719,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_91 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_719,"EOF"));
            }
         }
      }
      ...
      {
         if(var_461.parse(param1))
         {
            var_44.push(var_461);
            if(false)
            {
               var_124["null"] = var_461;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1374,var_461));
            var_461 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_44 != null && var_124 != null && param1 < var_44.length)
         {
            _loc2_ = var_44[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_44.splice(param1,1);
               delete var_124[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
